/**
 * Loader generated by glad 2.0.0-beta on Sun Sep  6 00:16:51 2020
 *
 * Generator: C/C++
 * Specification: gl
 * Extensions: 303
...
#define GLAD_GLES2
#define GLAD_OPTION_GLES2_MX_GLOBAL
...
GLAD_API_CALL GladGLES2Context glad_gles2_context;

#define GLAD_GL_ES_VERSION_2_0 (glad_gles2_context.ES_VERSION_2_0)
#define GLAD_GL_ES_VERSION_3_0 (glad_gles2_context.ES_VERSION_3_0)
#define GLAD_GL_ES_VERSION_3_1 (glad_gles2_context.ES_VERSION_3_1)
#define GLAD_GL_ES_VERSION_3_2 (glad_gles2_context.ES_VERSION_3_2)
#define GLAD_GL_AMD_compressed_3DC_texture (glad_gles2_context.AMD_compressed_3DC_texture)
#define GLAD_GL_AMD_compressed_ATC_texture (glad_gles2_context.AMD_compressed_ATC_texture)
#define GLAD_GL_AMD_framebuffer_multisample_advanced (glad_gles2_context.AMD_framebuffer_multisample_advanced)
#define GLAD_GL_AMD_performance_monitor (glad_gles2_context.AMD_performance_monitor)
#define GLAD_GL_AMD_program_binary_Z400 (glad_gles2_context.AMD_program_binary_Z400)
#define GLAD_GL_ANDROID_extension_pack_es31a (glad_gles2_context.ANDROID_extension_pack_es31a)
#define GLAD_GL_ANGLE_depth_texture (glad_gles2_context.ANGLE_depth_texture)
#define GLAD_GL_ANGLE_framebuffer_blit (glad_gles2_context.ANGLE_framebuffer_blit)
#define GLAD_GL_ANGLE_framebuffer_multisample (glad_gles2_context.ANGLE_framebuffer_multisample)
#define GLAD_GL_ANGLE_instanced_arrays (glad_gles2_context.ANGLE_instanced_arrays)
#define GLAD_GL_ANGLE_pack_reverse_row_order (glad_gles2_context.ANGLE_pack_reverse_row_order)
#define GLAD_GL_ANGLE_program_binary (glad_gles2_context.ANGLE_program_binary)
#define GLAD_GL_ANGLE_texture_compression_dxt3 (glad_gles2_context.ANGLE_texture_compression_dxt3)
#define GLAD_GL_ANGLE_texture_compression_dxt5 (glad_gles2_context.ANGLE_texture_compression_dxt5)
#define GLAD_GL_ANGLE_texture_usage (glad_gles2_context.ANGLE_texture_usage)
#define GLAD_GL_ANGLE_translated_shader_source (glad_gles2_context.ANGLE_translated_shader_source)
#define GLAD_GL_APPLE_clip_distance (glad_gles2_context.APPLE_clip_distance)
#define GLAD_GL_APPLE_color_buffer_packed_float (glad_gles2_context.APPLE_color_buffer_packed_float)
#define GLAD_GL_APPLE_copy_texture_levels (glad_gles2_context.APPLE_copy_texture_levels)
#define GLAD_GL_APPLE_framebuffer_multisample (glad_gles2_context.APPLE_framebuffer_multisample)
#define GLAD_GL_APPLE_rgb_422 (glad_gles2_context.APPLE_rgb_422)
#define GLAD_GL_APPLE_sync (glad_gles2_context.APPLE_sync)
#define GLAD_GL_APPLE_texture_format_BGRA8888 (glad_gles2_context.APPLE_texture_format_BGRA8888)
#define GLAD_GL_APPLE_texture_max_level (glad_gles2_context.APPLE_texture_max_level)
#define GLAD_GL_APPLE_texture_packed_float (glad_gles2_context.APPLE_texture_packed_float)
#define GLAD_GL_ARM_mali_program_binary (glad_gles2_context.ARM_mali_program_binary)
#define GLAD_GL_ARM_mali_shader_binary (glad_gles2_context.ARM_mali_shader_binary)
#define GLAD_GL_ARM_rgba8 (glad_gles2_context.ARM_rgba8)
#define GLAD_GL_ARM_shader_framebuffer_fetch (glad_gles2_context.ARM_shader_framebuffer_fetch)
#define GLAD_GL_ARM_shader_framebuffer_fetch_depth_stencil (glad_gles2_context.ARM_shader_framebuffer_fetch_depth_stencil)
#define GLAD_GL_ARM_texture_unnormalized_coordinates (glad_gles2_context.ARM_texture_unnormalized_coordinates)
#define GLAD_GL_DMP_program_binary (glad_gles2_context.DMP_program_binary)
#define GLAD_GL_DMP_shader_binary (glad_gles2_context.DMP_shader_binary)
#define GLAD_GL_EXT_EGL_image_array (glad_gles2_context.EXT_EGL_image_array)
#define GLAD_GL_EXT_EGL_image_storage (glad_gles2_context.EXT_EGL_image_storage)
#define GLAD_GL_EXT_YUV_target (glad_gles2_context.EXT_YUV_target)
#define GLAD_GL_EXT_base_instance (glad_gles2_context.EXT_base_instance)
#define GLAD_GL_EXT_blend_func_extended (glad_gles2_context.EXT_blend_func_extended)
#define GLAD_GL_EXT_blend_minmax (glad_gles2_context.EXT_blend_minmax)
#define GLAD_GL_EXT_buffer_storage (glad_gles2_context.EXT_buffer_storage)
#define GLAD_GL_EXT_clear_texture (glad_gles2_context.EXT_clear_texture)
#define GLAD_GL_EXT_clip_control (glad_gles2_context.EXT_clip_control)
#define GLAD_GL_EXT_clip_cull_distance (glad_gles2_context.EXT_clip_cull_distance)
#define GLAD_GL_EXT_color_buffer_float (glad_gles2_context.EXT_color_buffer_float)
#define GLAD_GL_EXT_color_buffer_half_float (glad_gles2_context.EXT_color_buffer_half_float)
#define GLAD_GL_EXT_conservative_depth (glad_gles2_context.EXT_conservative_depth)
#define GLAD_GL_EXT_copy_image (glad_gles2_context.EXT_copy_image)
#define GLAD_GL_EXT_debug_label (glad_gles2_context.EXT_debug_label)
#define GLAD_GL_EXT_debug_marker (glad_gles2_context.EXT_debug_marker)
#define GLAD_GL_EXT_depth_clamp (glad_gles2_context.EXT_depth_clamp)
#define GLAD_GL_EXT_discard_framebuffer (glad_gles2_context.EXT_discard_framebuffer)
#define GLAD_GL_EXT_disjoint_timer_query (glad_gles2_context.EXT_disjoint_timer_query)
#define GLAD_GL_EXT_draw_buffers (glad_gles2_context.EXT_draw_buffers)
#define GLAD_GL_EXT_draw_buffers_indexed (glad_gles2_context.EXT_draw_buffers_indexed)
#define GLAD_GL_EXT_draw_elements_base_vertex (glad_gles2_context.EXT_draw_elements_base_vertex)
#define GLAD_GL_EXT_draw_instanced (glad_gles2_context.EXT_draw_instanced)
#define GLAD_GL_EXT_draw_transform_feedback (glad_gles2_context.EXT_draw_transform_feedback)
#define GLAD_GL_EXT_external_buffer (glad_gles2_context.EXT_external_buffer)
#define GLAD_GL_EXT_float_blend (glad_gles2_context.EXT_float_blend)
#define GLAD_GL_EXT_geometry_point_size (glad_gles2_context.EXT_geometry_point_size)
#define GLAD_GL_EXT_geometry_shader (glad_gles2_context.EXT_geometry_shader)
#define GLAD_GL_EXT_gpu_shader5 (glad_gles2_context.EXT_gpu_shader5)
#define GLAD_GL_EXT_instanced_arrays (glad_gles2_context.EXT_instanced_arrays)
#define GLAD_GL_EXT_map_buffer_range (glad_gles2_context.EXT_map_buffer_range)
#define GLAD_GL_EXT_memory_object (glad_gles2_context.EXT_memory_object)
#define GLAD_GL_EXT_memory_object_fd (glad_gles2_context.EXT_memory_object_fd)
#define GLAD_GL_EXT_memory_object_win32 (glad_gles2_context.EXT_memory_object_win32)
#define GLAD_GL_EXT_multi_draw_arrays (glad_gles2_context.EXT_multi_draw_arrays)
#define GLAD_GL_EXT_multi_draw_indirect (glad_gles2_context.EXT_multi_draw_indirect)
#define GLAD_GL_EXT_multisampled_compatibility (glad_gles2_context.EXT_multisampled_compatibility)
#define GLAD_GL_EXT_multisampled_render_to_texture (glad_gles2_context.EXT_multisampled_render_to_texture)
#define GLAD_GL_EXT_multisampled_render_to_texture2 (glad_gles2_context.EXT_multisampled_render_to_texture2)
#define GLAD_GL_EXT_multiview_draw_buffers (glad_gles2_context.EXT_multiview_draw_buffers)
#define GLAD_GL_EXT_multiview_tessellation_geometry_shader (glad_gles2_context.EXT_multiview_tessellation_geometry_shader)
#define GLAD_GL_EXT_multiview_texture_multisample (glad_gles2_context.EXT_multiview_texture_multisample)
#define GLAD_GL_EXT_multiview_timer_query (glad_gles2_context.EXT_multiview_timer_query)
#define GLAD_GL_EXT_occlusion_query_boolean (glad_gles2_context.EXT_occlusion_query_boolean)
#define GLAD_GL_EXT_polygon_offset_clamp (glad_gles2_context.EXT_polygon_offset_clamp)
#define GLAD_GL_EXT_post_depth_coverage (glad_gles2_context.EXT_post_depth_coverage)
#define GLAD_GL_EXT_primitive_bounding_box (glad_gles2_context.EXT_primitive_bounding_box)
#define GLAD_GL_EXT_protected_textures (glad_gles2_context.EXT_protected_textures)
#define GLAD_GL_EXT_pvrtc_sRGB (glad_gles2_context.EXT_pvrtc_sRGB)
#define GLAD_GL_EXT_raster_multisample (glad_gles2_context.EXT_raster_multisample)
#define GLAD_GL_EXT_read_format_bgra (glad_gles2_context.EXT_read_format_bgra)
#define GLAD_GL_EXT_render_snorm (glad_gles2_context.EXT_render_snorm)
#define GLAD_GL_EXT_robustness (glad_gles2_context.EXT_robustness)
#define GLAD_GL_EXT_sRGB (glad_gles2_context.EXT_sRGB)
#define GLAD_GL_EXT_sRGB_write_control (glad_gles2_context.EXT_sRGB_write_control)
#define GLAD_GL_EXT_semaphore (glad_gles2_context.EXT_semaphore)
#define GLAD_GL_EXT_semaphore_fd (glad_gles2_context.EXT_semaphore_fd)
#define GLAD_GL_EXT_semaphore_win32 (glad_gles2_context.EXT_semaphore_win32)
#define GLAD_GL_EXT_separate_shader_objects (glad_gles2_context.EXT_separate_shader_objects)
#define GLAD_GL_EXT_shader_framebuffer_fetch (glad_gles2_context.EXT_shader_framebuffer_fetch)
#define GLAD_GL_EXT_shader_framebuffer_fetch_non_coherent (glad_gles2_context.EXT_shader_framebuffer_fetch_non_coherent)
#define GLAD_GL_EXT_shader_group_vote (glad_gles2_context.EXT_shader_group_vote)
#define GLAD_GL_EXT_shader_implicit_conversions (glad_gles2_context.EXT_shader_implicit_conversions)
#define GLAD_GL_EXT_shader_integer_mix (glad_gles2_context.EXT_shader_integer_mix)
#define GLAD_GL_EXT_shader_io_blocks (glad_gles2_context.EXT_shader_io_blocks)
#define GLAD_GL_EXT_shader_non_constant_global_initializers (glad_gles2_context.EXT_shader_non_constant_global_initializers)
#define GLAD_GL_EXT_shader_pixel_local_storage (glad_gles2_context.EXT_shader_pixel_local_storage)
#define GLAD_GL_EXT_shader_pixel_local_storage2 (glad_gles2_context.EXT_shader_pixel_local_storage2)
#define GLAD_GL_EXT_shader_texture_lod (glad_gles2_context.EXT_shader_texture_lod)
#define GLAD_GL_EXT_shadow_samplers (glad_gles2_context.EXT_shadow_samplers)
#define GLAD_GL_EXT_sparse_texture (glad_gles2_context.EXT_sparse_texture)
#define GLAD_GL_EXT_sparse_texture2 (glad_gles2_context.EXT_sparse_texture2)
#define GLAD_GL_EXT_tessellation_point_size (glad_gles2_context.EXT_tessellation_point_size)
#define GLAD_GL_EXT_tessellation_shader (glad_gles2_context.EXT_tessellation_shader)
#define GLAD_GL_EXT_texture_border_clamp (glad_gles2_context.EXT_texture_border_clamp)
#define GLAD_GL_EXT_texture_buffer (glad_gles2_context.EXT_texture_buffer)
#define GLAD_GL_EXT_texture_compression_astc_decode_mode (glad_gles2_context.EXT_texture_compression_astc_decode_mode)
#define GLAD_GL_EXT_texture_compression_bptc (glad_gles2_context.EXT_texture_compression_bptc)
#define GLAD_GL_EXT_texture_compression_dxt1 (glad_gles2_context.EXT_texture_compression_dxt1)
#define GLAD_GL_EXT_texture_compression_rgtc (glad_gles2_context.EXT_texture_compression_rgtc)
#define GLAD_GL_EXT_texture_compression_s3tc (glad_gles2_context.EXT_texture_compression_s3tc)
#define GLAD_GL_EXT_texture_compression_s3tc_srgb (glad_gles2_context.EXT_texture_compression_s3tc_srgb)
#define GLAD_GL_EXT_texture_cube_map_array (glad_gles2_context.EXT_texture_cube_map_array)
#define GLAD_GL_EXT_texture_filter_anisotropic (glad_gles2_context.EXT_texture_filter_anisotropic)
#define GLAD_GL_EXT_texture_filter_minmax (glad_gles2_context.EXT_texture_filter_minmax)
#define GLAD_GL_EXT_texture_format_BGRA8888 (glad_gles2_context.EXT_texture_format_BGRA8888)
#define GLAD_GL_EXT_texture_format_sRGB_override (glad_gles2_context.EXT_texture_format_sRGB_override)
#define GLAD_GL_EXT_texture_mirror_clamp_to_edge (glad_gles2_context.EXT_texture_mirror_clamp_to_edge)
#define GLAD_GL_EXT_texture_norm16 (glad_gles2_context.EXT_texture_norm16)
#define GLAD_GL_EXT_texture_query_lod (glad_gles2_context.EXT_texture_query_lod)
#define GLAD_GL_EXT_texture_rg (glad_gles2_context.EXT_texture_rg)
#define GLAD_GL_EXT_texture_sRGB_R8 (glad_gles2_context.EXT_texture_sRGB_R8)
#define GLAD_GL_EXT_texture_sRGB_RG8 (glad_gles2_context.EXT_texture_sRGB_RG8)
#define GLAD_GL_EXT_texture_sRGB_decode (glad_gles2_context.EXT_texture_sRGB_decode)
#define GLAD_GL_EXT_texture_shadow_lod (glad_gles2_context.EXT_texture_shadow_lod)
#define GLAD_GL_EXT_texture_storage (glad_gles2_context.EXT_texture_storage)
#define GLAD_GL_EXT_texture_type_2_10_10_10_REV (glad_gles2_context.EXT_texture_type_2_10_10_10_REV)
#define GLAD_GL_EXT_texture_view (glad_gles2_context.EXT_texture_view)
#define GLAD_GL_EXT_unpack_subimage (glad_gles2_context.EXT_unpack_subimage)
#define GLAD_GL_EXT_win32_keyed_mutex (glad_gles2_context.EXT_win32_keyed_mutex)
#define GLAD_GL_EXT_window_rectangles (glad_gles2_context.EXT_window_rectangles)
#define GLAD_GL_FJ_shader_binary_GCCSO (glad_gles2_context.FJ_shader_binary_GCCSO)
#define GLAD_GL_IMG_bindless_texture (glad_gles2_context.IMG_bindless_texture)
#define GLAD_GL_IMG_framebuffer_downsample (glad_gles2_context.IMG_framebuffer_downsample)
#define GLAD_GL_IMG_multisampled_render_to_texture (glad_gles2_context.IMG_multisampled_render_to_texture)
#define GLAD_GL_IMG_program_binary (glad_gles2_context.IMG_program_binary)
#define GLAD_GL_IMG_read_format (glad_gles2_context.IMG_read_format)
#define GLAD_GL_IMG_shader_binary (glad_gles2_context.IMG_shader_binary)
#define GLAD_GL_IMG_texture_compression_pvrtc (glad_gles2_context.IMG_texture_compression_pvrtc)
#define GLAD_GL_IMG_texture_compression_pvrtc2 (glad_gles2_context.IMG_texture_compression_pvrtc2)
#define GLAD_GL_IMG_texture_filter_cubic (glad_gles2_context.IMG_texture_filter_cubic)
#define GLAD_GL_INTEL_blackhole_render (glad_gles2_context.INTEL_blackhole_render)
#define GLAD_GL_INTEL_conservative_rasterization (glad_gles2_context.INTEL_conservative_rasterization)
#define GLAD_GL_INTEL_framebuffer_CMAA (glad_gles2_context.INTEL_framebuffer_CMAA)
#define GLAD_GL_INTEL_performance_query (glad_gles2_context.INTEL_performance_query)
#define GLAD_GL_KHR_blend_equation_advanced (glad_gles2_context.KHR_blend_equation_advanced)
#define GLAD_GL_KHR_blend_equation_advanced_coherent (glad_gles2_context.KHR_blend_equation_advanced_coherent)
#define GLAD_GL_KHR_context_flush_control (glad_gles2_context.KHR_context_flush_control)
#define GLAD_GL_KHR_debug (glad_gles2_context.KHR_debug)
#define GLAD_GL_KHR_no_error (glad_gles2_context.KHR_no_error)
#define GLAD_GL_KHR_parallel_shader_compile (glad_gles2_context.KHR_parallel_shader_compile)
#define GLAD_GL_KHR_robust_buffer_access_behavior (glad_gles2_context.KHR_robust_buffer_access_behavior)
#define GLAD_GL_KHR_robustness (glad_gles2_context.KHR_robustness)
#define GLAD_GL_KHR_shader_subgroup (glad_gles2_context.KHR_shader_subgroup)
#define GLAD_GL_KHR_texture_compression_astc_hdr (glad_gles2_context.KHR_texture_compression_astc_hdr)
#define GLAD_GL_KHR_texture_compression_astc_ldr (glad_gles2_context.KHR_texture_compression_astc_ldr)
#define GLAD_GL_KHR_texture_compression_astc_sliced_3d (glad_gles2_context.KHR_texture_compression_astc_sliced_3d)
#define GLAD_GL_MESA_framebuffer_flip_x (glad_gles2_context.MESA_framebuffer_flip_x)
#define GLAD_GL_MESA_framebuffer_flip_y (glad_gles2_context.MESA_framebuffer_flip_y)
#define GLAD_GL_MESA_framebuffer_swap_xy (glad_gles2_context.MESA_framebuffer_swap_xy)
#define GLAD_GL_MESA_program_binary_formats (glad_gles2_context.MESA_program_binary_formats)
#define GLAD_GL_MESA_shader_integer_functions (glad_gles2_context.MESA_shader_integer_functions)
#define GLAD_GL_NVX_blend_equation_advanced_multi_draw_buffers (glad_gles2_context.NVX_blend_equation_advanced_multi_draw_buffers)
#define GLAD_GL_NV_bindless_texture (glad_gles2_context.NV_bindless_texture)
#define GLAD_GL_NV_blend_equation_advanced (glad_gles2_context.NV_blend_equation_advanced)
#define GLAD_GL_NV_blend_equation_advanced_coherent (glad_gles2_context.NV_blend_equation_advanced_coherent)
#define GLAD_GL_NV_blend_minmax_factor (glad_gles2_context.NV_blend_minmax_factor)
#define GLAD_GL_NV_clip_space_w_scaling (glad_gles2_context.NV_clip_space_w_scaling)
#define GLAD_GL_NV_compute_shader_derivatives (glad_gles2_context.NV_compute_shader_derivatives)
#define GLAD_GL_NV_conditional_render (glad_gles2_context.NV_conditional_render)
#define GLAD_GL_NV_conservative_raster (glad_gles2_context.NV_conservative_raster)
#define GLAD_GL_NV_conservative_raster_pre_snap (glad_gles2_context.NV_conservative_raster_pre_snap)
#define GLAD_GL_NV_conservative_raster_pre_snap_triangles (glad_gles2_context.NV_conservative_raster_pre_snap_triangles)
#define GLAD_GL_NV_copy_buffer (glad_gles2_context.NV_copy_buffer)
#define GLAD_GL_NV_coverage_sample (glad_gles2_context.NV_coverage_sample)
#define GLAD_GL_NV_depth_nonlinear (glad_gles2_context.NV_depth_nonlinear)
#define GLAD_GL_NV_draw_buffers (glad_gles2_context.NV_draw_buffers)
#define GLAD_GL_NV_draw_instanced (glad_gles2_context.NV_draw_instanced)
#define GLAD_GL_NV_draw_vulkan_image (glad_gles2_context.NV_draw_vulkan_image)
#define GLAD_GL_NV_explicit_attrib_location (glad_gles2_context.NV_explicit_attrib_location)
#define GLAD_GL_NV_fbo_color_attachments (glad_gles2_context.NV_fbo_color_attachments)
#define GLAD_GL_NV_fence (glad_gles2_context.NV_fence)
#define GLAD_GL_NV_fill_rectangle (glad_gles2_context.NV_fill_rectangle)
#define GLAD_GL_NV_fragment_coverage_to_color (glad_gles2_context.NV_fragment_coverage_to_color)
#define GLAD_GL_NV_fragment_shader_barycentric (glad_gles2_context.NV_fragment_shader_barycentric)
#define GLAD_GL_NV_fragment_shader_interlock (glad_gles2_context.NV_fragment_shader_interlock)
#define GLAD_GL_NV_framebuffer_blit (glad_gles2_context.NV_framebuffer_blit)
#define GLAD_GL_NV_framebuffer_mixed_samples (glad_gles2_context.NV_framebuffer_mixed_samples)
#define GLAD_GL_NV_framebuffer_multisample (glad_gles2_context.NV_framebuffer_multisample)
#define GLAD_GL_NV_generate_mipmap_sRGB (glad_gles2_context.NV_generate_mipmap_sRGB)
#define GLAD_GL_NV_geometry_shader_passthrough (glad_gles2_context.NV_geometry_shader_passthrough)
#define GLAD_GL_NV_gpu_shader5 (glad_gles2_context.NV_gpu_shader5)
#define GLAD_GL_NV_image_formats (glad_gles2_context.NV_image_formats)
#define GLAD_GL_NV_instanced_arrays (glad_gles2_context.NV_instanced_arrays)
#define GLAD_GL_NV_internalformat_sample_query (glad_gles2_context.NV_internalformat_sample_query)
#define GLAD_GL_NV_memory_attachment (glad_gles2_context.NV_memory_attachment)
#define GLAD_GL_NV_memory_object_sparse (glad_gles2_context.NV_memory_object_sparse)
#define GLAD_GL_NV_mesh_shader (glad_gles2_context.NV_mesh_shader)
#define GLAD_GL_NV_non_square_matrices (glad_gles2_context.NV_non_square_matrices)
#define GLAD_GL_NV_path_rendering (glad_gles2_context.NV_path_rendering)
#define GLAD_GL_NV_path_rendering_shared_edge (glad_gles2_context.NV_path_rendering_shared_edge)
#define GLAD_GL_NV_pixel_buffer_object (glad_gles2_context.NV_pixel_buffer_object)
#define GLAD_GL_NV_polygon_mode (glad_gles2_context.NV_polygon_mode)
#define GLAD_GL_NV_read_buffer (glad_gles2_context.NV_read_buffer)
#define GLAD_GL_NV_read_buffer_front (glad_gles2_context.NV_read_buffer_front)
#define GLAD_GL_NV_read_depth (glad_gles2_context.NV_read_depth)
#define GLAD_GL_NV_read_depth_stencil (glad_gles2_context.NV_read_depth_stencil)
#define GLAD_GL_NV_read_stencil (glad_gles2_context.NV_read_stencil)
#define GLAD_GL_NV_representative_fragment_test (glad_gles2_context.NV_representative_fragment_test)
#define GLAD_GL_NV_sRGB_formats (glad_gles2_context.NV_sRGB_formats)
#define GLAD_GL_NV_sample_locations (glad_gles2_context.NV_sample_locations)
#define GLAD_GL_NV_sample_mask_override_coverage (glad_gles2_context.NV_sample_mask_override_coverage)
#define GLAD_GL_NV_scissor_exclusive (glad_gles2_context.NV_scissor_exclusive)
#define GLAD_GL_NV_shader_atomic_fp16_vector (glad_gles2_context.NV_shader_atomic_fp16_vector)
#define GLAD_GL_NV_shader_noperspective_interpolation (glad_gles2_context.NV_shader_noperspective_interpolation)
#define GLAD_GL_NV_shader_subgroup_partitioned (glad_gles2_context.NV_shader_subgroup_partitioned)
#define GLAD_GL_NV_shader_texture_footprint (glad_gles2_context.NV_shader_texture_footprint)
#define GLAD_GL_NV_shading_rate_image (glad_gles2_context.NV_shading_rate_image)
#define GLAD_GL_NV_shadow_samplers_array (glad_gles2_context.NV_shadow_samplers_array)
#define GLAD_GL_NV_shadow_samplers_cube (glad_gles2_context.NV_shadow_samplers_cube)
#define GLAD_GL_NV_stereo_view_rendering (glad_gles2_context.NV_stereo_view_rendering)
#define GLAD_GL_NV_texture_border_clamp (glad_gles2_context.NV_texture_border_clamp)
#define GLAD_GL_NV_texture_compression_s3tc_update (glad_gles2_context.NV_texture_compression_s3tc_update)
#define GLAD_GL_NV_texture_npot_2D_mipmap (glad_gles2_context.NV_texture_npot_2D_mipmap)
#define GLAD_GL_NV_timeline_semaphore (glad_gles2_context.NV_timeline_semaphore)
#define GLAD_GL_NV_viewport_array (glad_gles2_context.NV_viewport_array)
#define GLAD_GL_NV_viewport_array2 (glad_gles2_context.NV_viewport_array2)
#define GLAD_GL_NV_viewport_swizzle (glad_gles2_context.NV_viewport_swizzle)
#define GLAD_GL_OES_EGL_image (glad_gles2_context.OES_EGL_image)
#define GLAD_GL_OES_EGL_image_external (glad_gles2_context.OES_EGL_image_external)
#define GLAD_GL_OES_EGL_image_external_essl3 (glad_gles2_context.OES_EGL_image_external_essl3)
#define GLAD_GL_OES_compressed_ETC1_RGB8_sub_texture (glad_gles2_context.OES_compressed_ETC1_RGB8_sub_texture)
#define GLAD_GL_OES_compressed_ETC1_RGB8_texture (glad_gles2_context.OES_compressed_ETC1_RGB8_texture)
#define GLAD_GL_OES_compressed_paletted_texture (glad_gles2_context.OES_compressed_paletted_texture)
#define GLAD_GL_OES_copy_image (glad_gles2_context.OES_copy_image)
#define GLAD_GL_OES_depth24 (glad_gles2_context.OES_depth24)
#define GLAD_GL_OES_depth32 (glad_gles2_context.OES_depth32)
#define GLAD_GL_OES_depth_texture (glad_gles2_context.OES_depth_texture)
#define GLAD_GL_OES_draw_buffers_indexed (glad_gles2_context.OES_draw_buffers_indexed)
#define GLAD_GL_OES_draw_elements_base_vertex (glad_gles2_context.OES_draw_elements_base_vertex)
#define GLAD_GL_OES_element_index_uint (glad_gles2_context.OES_element_index_uint)
#define GLAD_GL_OES_fbo_render_mipmap (glad_gles2_context.OES_fbo_render_mipmap)
#define GLAD_GL_OES_fragment_precision_high (glad_gles2_context.OES_fragment_precision_high)
#define GLAD_GL_OES_geometry_point_size (glad_gles2_context.OES_geometry_point_size)
#define GLAD_GL_OES_geometry_shader (glad_gles2_context.OES_geometry_shader)
#define GLAD_GL_OES_get_program_binary (glad_gles2_context.OES_get_program_binary)
#define GLAD_GL_OES_gpu_shader5 (glad_gles2_context.OES_gpu_shader5)
#define GLAD_GL_OES_mapbuffer (glad_gles2_context.OES_mapbuffer)
#define GLAD_GL_OES_packed_depth_stencil (glad_gles2_context.OES_packed_depth_stencil)
#define GLAD_GL_OES_primitive_bounding_box (glad_gles2_context.OES_primitive_bounding_box)
#define GLAD_GL_OES_required_internalformat (glad_gles2_context.OES_required_internalformat)
#define GLAD_GL_OES_rgb8_rgba8 (glad_gles2_context.OES_rgb8_rgba8)
#define GLAD_GL_OES_sample_shading (glad_gles2_context.OES_sample_shading)
#define GLAD_GL_OES_sample_variables (glad_gles2_context.OES_sample_variables)
#define GLAD_GL_OES_shader_image_atomic (glad_gles2_context.OES_shader_image_atomic)
#define GLAD_GL_OES_shader_io_blocks (glad_gles2_context.OES_shader_io_blocks)
#define GLAD_GL_OES_shader_multisample_interpolation (glad_gles2_context.OES_shader_multisample_interpolation)
#define GLAD_GL_OES_standard_derivatives (glad_gles2_context.OES_standard_derivatives)
#define GLAD_GL_OES_stencil1 (glad_gles2_context.OES_stencil1)
#define GLAD_GL_OES_stencil4 (glad_gles2_context.OES_stencil4)
#define GLAD_GL_OES_surfaceless_context (glad_gles2_context.OES_surfaceless_context)
#define GLAD_GL_OES_tessellation_point_size (glad_gles2_context.OES_tessellation_point_size)
#define GLAD_GL_OES_tessellation_shader (glad_gles2_context.OES_tessellation_shader)
#define GLAD_GL_OES_texture_3D (glad_gles2_context.OES_texture_3D)
#define GLAD_GL_OES_texture_border_clamp (glad_gles2_context.OES_texture_border_clamp)
#define GLAD_GL_OES_texture_buffer (glad_gles2_context.OES_texture_buffer)
#define GLAD_GL_OES_texture_compression_astc (glad_gles2_context.OES_texture_compression_astc)
#define GLAD_GL_OES_texture_cube_map_array (glad_gles2_context.OES_texture_cube_map_array)
#define GLAD_GL_OES_texture_float (glad_gles2_context.OES_texture_float)
#define GLAD_GL_OES_texture_float_linear (glad_gles2_context.OES_texture_float_linear)
#define GLAD_GL_OES_texture_half_float (glad_gles2_context.OES_texture_half_float)
#define GLAD_GL_OES_texture_half_float_linear (glad_gles2_context.OES_texture_half_float_linear)
#define GLAD_GL_OES_texture_npot (glad_gles2_context.OES_texture_npot)
#define GLAD_GL_OES_texture_stencil8 (glad_gles2_context.OES_texture_stencil8)
#define GLAD_GL_OES_texture_storage_multisample_2d_array (glad_gles2_context.OES_texture_storage_multisample_2d_array)
#define GLAD_GL_OES_texture_view (glad_gles2_context.OES_texture_view)
#define GLAD_GL_OES_vertex_array_object (glad_gles2_context.OES_vertex_array_object)
#define GLAD_GL_OES_vertex_half_float (glad_gles2_context.OES_vertex_half_float)
#define GLAD_GL_OES_vertex_type_10_10_10_2 (glad_gles2_context.OES_vertex_type_10_10_10_2)
#define GLAD_GL_OES_viewport_array (glad_gles2_context.OES_viewport_array)
#define GLAD_GL_OVR_multiview (glad_gles2_context.OVR_multiview)
#define GLAD_GL_OVR_multiview2 (glad_gles2_context.OVR_multiview2)
#define GLAD_GL_OVR_multiview_multisampled_render_to_texture (glad_gles2_context.OVR_multiview_multisampled_render_to_texture)
#define GLAD_GL_QCOM_YUV_texture_gather (glad_gles2_context.QCOM_YUV_texture_gather)
#define GLAD_GL_QCOM_alpha_test (glad_gles2_context.QCOM_alpha_test)
#define GLAD_GL_QCOM_binning_control (glad_gles2_context.QCOM_binning_control)
#define GLAD_GL_QCOM_driver_control (glad_gles2_context.QCOM_driver_control)
#define GLAD_GL_QCOM_extended_get (glad_gles2_context.QCOM_extended_get)
#define GLAD_GL_QCOM_extended_get2 (glad_gles2_context.QCOM_extended_get2)
#define GLAD_GL_QCOM_framebuffer_foveated (glad_gles2_context.QCOM_framebuffer_foveated)
#define GLAD_GL_QCOM_motion_estimation (glad_gles2_context.QCOM_motion_estimation)
#define GLAD_GL_QCOM_perfmon_global_mode (glad_gles2_context.QCOM_perfmon_global_mode)
#define GLAD_GL_QCOM_shader_framebuffer_fetch_noncoherent (glad_gles2_context.QCOM_shader_framebuffer_fetch_noncoherent)
#define GLAD_GL_QCOM_shader_framebuffer_fetch_rate (glad_gles2_context.QCOM_shader_framebuffer_fetch_rate)
#define GLAD_GL_QCOM_shading_rate (glad_gles2_context.QCOM_shading_rate)
#define GLAD_GL_QCOM_texture_foveated (glad_gles2_context.QCOM_texture_foveated)
#define GLAD_GL_QCOM_texture_foveated_subsampled_layout (glad_gles2_context.QCOM_texture_foveated_subsampled_layout)
#define GLAD_GL_QCOM_tiled_rendering (glad_gles2_context.QCOM_tiled_rendering)
#define GLAD_GL_QCOM_writeonly_rendering (glad_gles2_context.QCOM_writeonly_rendering)
#define GLAD_GL_VIV_shader_binary (glad_gles2_context.VIV_shader_binary)

#define glAcquireKeyedMutexWin32EXT (glad_gles2_context.AcquireKeyedMutexWin32EXT)
#define glActiveShaderProgram (glad_gles2_context.ActiveShaderProgram)
#define glActiveShaderProgramEXT (glad_gles2_context.ActiveShaderProgramEXT)
#define glActiveTexture (glad_gles2_context.ActiveTexture)
#define glAlphaFuncQCOM (glad_gles2_context.AlphaFuncQCOM)
#define glApplyFramebufferAttachmentCMAAINTEL (glad_gles2_context.ApplyFramebufferAttachmentCMAAINTEL)
#define glAttachShader (glad_gles2_context.AttachShader)
#define glBeginConditionalRenderNV (glad_gles2_context.BeginConditionalRenderNV)
#define glBeginPerfMonitorAMD (glad_gles2_context.BeginPerfMonitorAMD)
#define glBeginPerfQueryINTEL (glad_gles2_context.BeginPerfQueryINTEL)
#define glBeginQuery (glad_gles2_context.BeginQuery)
#define glBeginQueryEXT (glad_gles2_context.BeginQueryEXT)
#define glBeginTransformFeedback (glad_gles2_context.BeginTransformFeedback)
#define glBindAttribLocation (glad_gles2_context.BindAttribLocation)
#define glBindBuffer (glad_gles2_context.BindBuffer)
#define glBindBufferBase (glad_gles2_context.BindBufferBase)
#define glBindBufferRange (glad_gles2_context.BindBufferRange)
#define glBindFragDataLocationEXT (glad_gles2_context.BindFragDataLocationEXT)
#define glBindFragDataLocationIndexedEXT (glad_gles2_context.BindFragDataLocationIndexedEXT)
#define glBindFramebuffer (glad_gles2_context.BindFramebuffer)
#define glBindImageTexture (glad_gles2_context.BindImageTexture)
#define glBindProgramPipeline (glad_gles2_context.BindProgramPipeline)
#define glBindProgramPipelineEXT (glad_gles2_context.BindProgramPipelineEXT)
#define glBindRenderbuffer (glad_gles2_context.BindRenderbuffer)
#define glBindSampler (glad_gles2_context.BindSampler)
#define glBindShadingRateImageNV (glad_gles2_context.BindShadingRateImageNV)
#define glBindTexture (glad_gles2_context.BindTexture)
#define glBindTransformFeedback (glad_gles2_context.BindTransformFeedback)
#define glBindVertexArray (glad_gles2_context.BindVertexArray)
#define glBindVertexArrayOES (glad_gles2_context.BindVertexArrayOES)
#define glBindVertexBuffer (glad_gles2_context.BindVertexBuffer)
#define glBlendBarrier (glad_gles2_context.BlendBarrier)
#define glBlendBarrierKHR (glad_gles2_context.BlendBarrierKHR)
#define glBlendBarrierNV (glad_gles2_context.BlendBarrierNV)
#define glBlendColor (glad_gles2_context.BlendColor)
#define glBlendEquation (glad_gles2_context.BlendEquation)
#define glBlendEquationSeparate (glad_gles2_context.BlendEquationSeparate)
#define glBlendEquationSeparatei (glad_gles2_context.BlendEquationSeparatei)
#define glBlendEquationSeparateiEXT (glad_gles2_context.BlendEquationSeparateiEXT)
#define glBlendEquationSeparateiOES (glad_gles2_context.BlendEquationSeparateiOES)
#define glBlendEquationi (glad_gles2_context.BlendEquationi)
#define glBlendEquationiEXT (glad_gles2_context.BlendEquationiEXT)
#define glBlendEquationiOES (glad_gles2_context.BlendEquationiOES)
#define glBlendFunc (glad_gles2_context.BlendFunc)
#define glBlendFuncSeparate (glad_gles2_context.BlendFuncSeparate)
#define glBlendFuncSeparatei (glad_gles2_context.BlendFuncSeparatei)
#define glBlendFuncSeparateiEXT (glad_gles2_context.BlendFuncSeparateiEXT)
#define glBlendFuncSeparateiOES (glad_gles2_context.BlendFuncSeparateiOES)
#define glBlendFunci (glad_gles2_context.BlendFunci)
#define glBlendFunciEXT (glad_gles2_context.BlendFunciEXT)
#define glBlendFunciOES (glad_gles2_context.BlendFunciOES)
#define glBlendParameteriNV (glad_gles2_context.BlendParameteriNV)
#define glBlitFramebuffer (glad_gles2_context.BlitFramebuffer)
#define glBlitFramebufferANGLE (glad_gles2_context.BlitFramebufferANGLE)
#define glBlitFramebufferNV (glad_gles2_context.BlitFramebufferNV)
#define glBufferAttachMemoryNV (glad_gles2_context.BufferAttachMemoryNV)
#define glBufferData (glad_gles2_context.BufferData)
#define glBufferPageCommitmentMemNV (glad_gles2_context.BufferPageCommitmentMemNV)
#define glBufferStorageEXT (glad_gles2_context.BufferStorageEXT)
#define glBufferStorageExternalEXT (glad_gles2_context.BufferStorageExternalEXT)
#define glBufferStorageMemEXT (glad_gles2_context.BufferStorageMemEXT)
#define glBufferSubData (glad_gles2_context.BufferSubData)
#define glCheckFramebufferStatus (glad_gles2_context.CheckFramebufferStatus)
#define glClear (glad_gles2_context.Clear)
#define glClearBufferfi (glad_gles2_context.ClearBufferfi)
#define glClearBufferfv (glad_gles2_context.ClearBufferfv)
#define glClearBufferiv (glad_gles2_context.ClearBufferiv)
#define glClearBufferuiv (glad_gles2_context.ClearBufferuiv)
#define glClearColor (glad_gles2_context.ClearColor)
#define glClearDepthf (glad_gles2_context.ClearDepthf)
#define glClearPixelLocalStorageuiEXT (glad_gles2_context.ClearPixelLocalStorageuiEXT)
#define glClearStencil (glad_gles2_context.ClearStencil)
#define glClearTexImageEXT (glad_gles2_context.ClearTexImageEXT)
#define glClearTexSubImageEXT (glad_gles2_context.ClearTexSubImageEXT)
#define glClientWaitSync (glad_gles2_context.ClientWaitSync)
#define glClientWaitSyncAPPLE (glad_gles2_context.ClientWaitSyncAPPLE)
#define glClipControlEXT (glad_gles2_context.ClipControlEXT)
#define glColorMask (glad_gles2_context.ColorMask)
#define glColorMaski (glad_gles2_context.ColorMaski)
#define glColorMaskiEXT (glad_gles2_context.ColorMaskiEXT)
#define glColorMaskiOES (glad_gles2_context.ColorMaskiOES)
#define glCompileShader (glad_gles2_context.CompileShader)
#define glCompressedTexImage2D (glad_gles2_context.CompressedTexImage2D)
#define glCompressedTexImage3D (glad_gles2_context.CompressedTexImage3D)
#define glCompressedTexImage3DOES (glad_gles2_context.CompressedTexImage3DOES)
#define glCompressedTexSubImage2D (glad_gles2_context.CompressedTexSubImage2D)
#define glCompressedTexSubImage3D (glad_gles2_context.CompressedTexSubImage3D)
#define glCompressedTexSubImage3DOES (glad_gles2_context.CompressedTexSubImage3DOES)
#define glConservativeRasterParameteriNV (glad_gles2_context.ConservativeRasterParameteriNV)
#define glCopyBufferSubData (glad_gles2_context.CopyBufferSubData)
#define glCopyBufferSubDataNV (glad_gles2_context.CopyBufferSubDataNV)
#define glCopyImageSubData (glad_gles2_context.CopyImageSubData)
#define glCopyImageSubDataEXT (glad_gles2_context.CopyImageSubDataEXT)
#define glCopyImageSubDataOES (glad_gles2_context.CopyImageSubDataOES)
#define glCopyPathNV (glad_gles2_context.CopyPathNV)
#define glCopyTexImage2D (glad_gles2_context.CopyTexImage2D)
#define glCopyTexSubImage2D (glad_gles2_context.CopyTexSubImage2D)
#define glCopyTexSubImage3D (glad_gles2_context.CopyTexSubImage3D)
#define glCopyTexSubImage3DOES (glad_gles2_context.CopyTexSubImage3DOES)
#define glCopyTextureLevelsAPPLE (glad_gles2_context.CopyTextureLevelsAPPLE)
#define glCoverFillPathInstancedNV (glad_gles2_context.CoverFillPathInstancedNV)
#define glCoverFillPathNV (glad_gles2_context.CoverFillPathNV)
#define glCoverStrokePathInstancedNV (glad_gles2_context.CoverStrokePathInstancedNV)
#define glCoverStrokePathNV (glad_gles2_context.CoverStrokePathNV)
#define glCoverageMaskNV (glad_gles2_context.CoverageMaskNV)
#define glCoverageModulationNV (glad_gles2_context.CoverageModulationNV)
#define glCoverageModulationTableNV (glad_gles2_context.CoverageModulationTableNV)
#define glCoverageOperationNV (glad_gles2_context.CoverageOperationNV)
#define glCreateMemoryObjectsEXT (glad_gles2_context.CreateMemoryObjectsEXT)
#define glCreatePerfQueryINTEL (glad_gles2_context.CreatePerfQueryINTEL)
#define glCreateProgram (glad_gles2_context.CreateProgram)
#define glCreateSemaphoresNV (glad_gles2_context.CreateSemaphoresNV)
#define glCreateShader (glad_gles2_context.CreateShader)
#define glCreateShaderProgramv (glad_gles2_context.CreateShaderProgramv)
#define glCreateShaderProgramvEXT (glad_gles2_context.CreateShaderProgramvEXT)
#define glCullFace (glad_gles2_context.CullFace)
#define glDebugMessageCallback (glad_gles2_context.DebugMessageCallback)
#define glDebugMessageCallbackKHR (glad_gles2_context.DebugMessageCallbackKHR)
#define glDebugMessageControl (glad_gles2_context.DebugMessageControl)
#define glDebugMessageControlKHR (glad_gles2_context.DebugMessageControlKHR)
#define glDebugMessageInsert (glad_gles2_context.DebugMessageInsert)
#define glDebugMessageInsertKHR (glad_gles2_context.DebugMessageInsertKHR)
#define glDeleteBuffers (glad_gles2_context.DeleteBuffers)
#define glDeleteFencesNV (glad_gles2_context.DeleteFencesNV)
#define glDeleteFramebuffers (glad_gles2_context.DeleteFramebuffers)
#define glDeleteMemoryObjectsEXT (glad_gles2_context.DeleteMemoryObjectsEXT)
#define glDeletePathsNV (glad_gles2_context.DeletePathsNV)
#define glDeletePerfMonitorsAMD (glad_gles2_context.DeletePerfMonitorsAMD)
#define glDeletePerfQueryINTEL (glad_gles2_context.DeletePerfQueryINTEL)
#define glDeleteProgram (glad_gles2_context.DeleteProgram)
#define glDeleteProgramPipelines (glad_gles2_context.DeleteProgramPipelines)
#define glDeleteProgramPipelinesEXT (glad_gles2_context.DeleteProgramPipelinesEXT)
#define glDeleteQueries (glad_gles2_context.DeleteQueries)
#define glDeleteQueriesEXT (glad_gles2_context.DeleteQueriesEXT)
#define glDeleteRenderbuffers (glad_gles2_context.DeleteRenderbuffers)
#define glDeleteSamplers (glad_gles2_context.DeleteSamplers)
#define glDeleteSemaphoresEXT (glad_gles2_context.DeleteSemaphoresEXT)
#define glDeleteShader (glad_gles2_context.DeleteShader)
#define glDeleteSync (glad_gles2_context.DeleteSync)
#define glDeleteSyncAPPLE (glad_gles2_context.DeleteSyncAPPLE)
#define glDeleteTextures (glad_gles2_context.DeleteTextures)
#define glDeleteTransformFeedbacks (glad_gles2_context.DeleteTransformFeedbacks)
#define glDeleteVertexArrays (glad_gles2_context.DeleteVertexArrays)
#define glDeleteVertexArraysOES (glad_gles2_context.DeleteVertexArraysOES)
#define glDepthFunc (glad_gles2_context.DepthFunc)
#define glDepthMask (glad_gles2_context.DepthMask)
#define glDepthRangeArrayfvNV (glad_gles2_context.DepthRangeArrayfvNV)
#define glDepthRangeArrayfvOES (glad_gles2_context.DepthRangeArrayfvOES)
#define glDepthRangeIndexedfNV (glad_gles2_context.DepthRangeIndexedfNV)
#define glDepthRangeIndexedfOES (glad_gles2_context.DepthRangeIndexedfOES)
#define glDepthRangef (glad_gles2_context.DepthRangef)
#define glDetachShader (glad_gles2_context.DetachShader)
#define glDisable (glad_gles2_context.Disable)
#define glDisableDriverControlQCOM (glad_gles2_context.DisableDriverControlQCOM)
#define glDisableVertexAttribArray (glad_gles2_context.DisableVertexAttribArray)
#define glDisablei (glad_gles2_context.Disablei)
#define glDisableiEXT (glad_gles2_context.DisableiEXT)
#define glDisableiNV (glad_gles2_context.DisableiNV)
#define glDisableiOES (glad_gles2_context.DisableiOES)
#define glDiscardFramebufferEXT (glad_gles2_context.DiscardFramebufferEXT)
#define glDispatchCompute (glad_gles2_context.DispatchCompute)
#define glDispatchComputeIndirect (glad_gles2_context.DispatchComputeIndirect)
#define glDrawArrays (glad_gles2_context.DrawArrays)
#define glDrawArraysIndirect (glad_gles2_context.DrawArraysIndirect)
#define glDrawArraysInstanced (glad_gles2_context.DrawArraysInstanced)
#define glDrawArraysInstancedANGLE (glad_gles2_context.DrawArraysInstancedANGLE)
#define glDrawArraysInstancedBaseInstanceEXT (glad_gles2_context.DrawArraysInstancedBaseInstanceEXT)
#define glDrawArraysInstancedEXT (glad_gles2_context.DrawArraysInstancedEXT)
#define glDrawArraysInstancedNV (glad_gles2_context.DrawArraysInstancedNV)
#define glDrawBuffers (glad_gles2_context.DrawBuffers)
#define glDrawBuffersEXT (glad_gles2_context.DrawBuffersEXT)
#define glDrawBuffersIndexedEXT (glad_gles2_context.DrawBuffersIndexedEXT)
#define glDrawBuffersNV (glad_gles2_context.DrawBuffersNV)
#define glDrawElements (glad_gles2_context.DrawElements)
#define glDrawElementsBaseVertex (glad_gles2_context.DrawElementsBaseVertex)
#define glDrawElementsBaseVertexEXT (glad_gles2_context.DrawElementsBaseVertexEXT)
#define glDrawElementsBaseVertexOES (glad_gles2_context.DrawElementsBaseVertexOES)
#define glDrawElementsIndirect (glad_gles2_context.DrawElementsIndirect)
#define glDrawElementsInstanced (glad_gles2_context.DrawElementsInstanced)
#define glDrawElementsInstancedANGLE (glad_gles2_context.DrawElementsInstancedANGLE)
#define glDrawElementsInstancedBaseInstanceEXT (glad_gles2_context.DrawElementsInstancedBaseInstanceEXT)
#define glDrawElementsInstancedBaseVertex (glad_gles2_context.DrawElementsInstancedBaseVertex)
#define glDrawElementsInstancedBaseVertexBaseInstanceEXT (glad_gles2_context.DrawElementsInstancedBaseVertexBaseInstanceEXT)
#define glDrawElementsInstancedBaseVertexEXT (glad_gles2_context.DrawElementsInstancedBaseVertexEXT)
#define glDrawElementsInstancedBaseVertexOES (glad_gles2_context.DrawElementsInstancedBaseVertexOES)
#define glDrawElementsInstancedEXT (glad_gles2_context.DrawElementsInstancedEXT)
#define glDrawElementsInstancedNV (glad_gles2_context.DrawElementsInstancedNV)
#define glDrawMeshTasksIndirectNV (glad_gles2_context.DrawMeshTasksIndirectNV)
#define glDrawMeshTasksNV (glad_gles2_context.DrawMeshTasksNV)
#define glDrawRangeElements (glad_gles2_context.DrawRangeElements)
#define glDrawRangeElementsBaseVertex (glad_gles2_context.DrawRangeElementsBaseVertex)
#define glDrawRangeElementsBaseVertexEXT (glad_gles2_context.DrawRangeElementsBaseVertexEXT)
#define glDrawRangeElementsBaseVertexOES (glad_gles2_context.DrawRangeElementsBaseVertexOES)
#define glDrawTransformFeedbackEXT (glad_gles2_context.DrawTransformFeedbackEXT)
#define glDrawTransformFeedbackInstancedEXT (glad_gles2_context.DrawTransformFeedbackInstancedEXT)
#define glDrawVkImageNV (glad_gles2_context.DrawVkImageNV)
#define glEGLImageTargetRenderbufferStorageOES (glad_gles2_context.EGLImageTargetRenderbufferStorageOES)
#define glEGLImageTargetTexStorageEXT (glad_gles2_context.EGLImageTargetTexStorageEXT)
#define glEGLImageTargetTexture2DOES (glad_gles2_context.EGLImageTargetTexture2DOES)
#define glEGLImageTargetTextureStorageEXT (glad_gles2_context.EGLImageTargetTextureStorageEXT)
#define glEnable (glad_gles2_context.Enable)
#define glEnableDriverControlQCOM (glad_gles2_context.EnableDriverControlQCOM)
#define glEnableVertexAttribArray (glad_gles2_context.EnableVertexAttribArray)
#define glEnablei (glad_gles2_context.Enablei)
#define glEnableiEXT (glad_gles2_context.EnableiEXT)
#define glEnableiNV (glad_gles2_context.EnableiNV)
#define glEnableiOES (glad_gles2_context.EnableiOES)
#define glEndConditionalRenderNV (glad_gles2_context.EndConditionalRenderNV)
#define glEndPerfMonitorAMD (glad_gles2_context.EndPerfMonitorAMD)
#define glEndPerfQueryINTEL (glad_gles2_context.EndPerfQueryINTEL)
#define glEndQuery (glad_gles2_context.EndQuery)
#define glEndQueryEXT (glad_gles2_context.EndQueryEXT)
#define glEndTilingQCOM (glad_gles2_context.EndTilingQCOM)
#define glEndTransformFeedback (glad_gles2_context.EndTransformFeedback)
#define glExtGetBufferPointervQCOM (glad_gles2_context.ExtGetBufferPointervQCOM)
#define glExtGetBuffersQCOM (glad_gles2_context.ExtGetBuffersQCOM)
#define glExtGetFramebuffersQCOM (glad_gles2_context.ExtGetFramebuffersQCOM)
#define glExtGetProgramBinarySourceQCOM (glad_gles2_context.ExtGetProgramBinarySourceQCOM)
#define glExtGetProgramsQCOM (glad_gles2_context.ExtGetProgramsQCOM)
#define glExtGetRenderbuffersQCOM (glad_gles2_context.ExtGetRenderbuffersQCOM)
#define glExtGetShadersQCOM (glad_gles2_context.ExtGetShadersQCOM)
#define glExtGetTexLevelParameterivQCOM (glad_gles2_context.ExtGetTexLevelParameterivQCOM)
#define glExtGetTexSubImageQCOM (glad_gles2_context.ExtGetTexSubImageQCOM)
#define glExtGetTexturesQCOM (glad_gles2_context.ExtGetTexturesQCOM)
#define glExtIsProgramBinaryQCOM (glad_gles2_context.ExtIsProgramBinaryQCOM)
#define glExtTexObjectStateOverrideiQCOM (glad_gles2_context.ExtTexObjectStateOverrideiQCOM)
#define glFenceSync (glad_gles2_context.FenceSync)
#define glFenceSyncAPPLE (glad_gles2_context.FenceSyncAPPLE)
#define glFinish (glad_gles2_context.Finish)
#define glFinishFenceNV (glad_gles2_context.FinishFenceNV)
#define glFlush (glad_gles2_context.Flush)
#define glFlushMappedBufferRange (glad_gles2_context.FlushMappedBufferRange)
#define glFlushMappedBufferRangeEXT (glad_gles2_context.FlushMappedBufferRangeEXT)
#define glFragmentCoverageColorNV (glad_gles2_context.FragmentCoverageColorNV)
#define glFramebufferFetchBarrierEXT (glad_gles2_context.FramebufferFetchBarrierEXT)
#define glFramebufferFetchBarrierQCOM (glad_gles2_context.FramebufferFetchBarrierQCOM)
#define glFramebufferFoveationConfigQCOM (glad_gles2_context.FramebufferFoveationConfigQCOM)
#define glFramebufferFoveationParametersQCOM (glad_gles2_context.FramebufferFoveationParametersQCOM)
#define glFramebufferParameteri (glad_gles2_context.FramebufferParameteri)
#define glFramebufferParameteriMESA (glad_gles2_context.FramebufferParameteriMESA)
#define glFramebufferPixelLocalStorageSizeEXT (glad_gles2_context.FramebufferPixelLocalStorageSizeEXT)
#define glFramebufferRenderbuffer (glad_gles2_context.FramebufferRenderbuffer)
#define glFramebufferSampleLocationsfvNV (glad_gles2_context.FramebufferSampleLocationsfvNV)
#define glFramebufferTexture (glad_gles2_context.FramebufferTexture)
#define glFramebufferTexture2D (glad_gles2_context.FramebufferTexture2D)
#define glFramebufferTexture2DDownsampleIMG (glad_gles2_context.FramebufferTexture2DDownsampleIMG)
#define glFramebufferTexture2DMultisampleEXT (glad_gles2_context.FramebufferTexture2DMultisampleEXT)
#define glFramebufferTexture2DMultisampleIMG (glad_gles2_context.FramebufferTexture2DMultisampleIMG)
#define glFramebufferTexture3DOES (glad_gles2_context.FramebufferTexture3DOES)
#define glFramebufferTextureEXT (glad_gles2_context.FramebufferTextureEXT)
#define glFramebufferTextureLayer (glad_gles2_context.FramebufferTextureLayer)
#define glFramebufferTextureLayerDownsampleIMG (glad_gles2_context.FramebufferTextureLayerDownsampleIMG)
#define glFramebufferTextureMultisampleMultiviewOVR (glad_gles2_context.FramebufferTextureMultisampleMultiviewOVR)
#define glFramebufferTextureMultiviewOVR (glad_gles2_context.FramebufferTextureMultiviewOVR)
#define glFramebufferTextureOES (glad_gles2_context.FramebufferTextureOES)
#define glFrontFace (glad_gles2_context.FrontFace)
#define glGenBuffers (glad_gles2_context.GenBuffers)
#define glGenFencesNV (glad_gles2_context.GenFencesNV)
#define glGenFramebuffers (glad_gles2_context.GenFramebuffers)
#define glGenPathsNV (glad_gles2_context.GenPathsNV)
#define glGenPerfMonitorsAMD (glad_gles2_context.GenPerfMonitorsAMD)
#define glGenProgramPipelines (glad_gles2_context.GenProgramPipelines)
#define glGenProgramPipelinesEXT (glad_gles2_context.GenProgramPipelinesEXT)
#define glGenQueries (glad_gles2_context.GenQueries)
#define glGenQueriesEXT (glad_gles2_context.GenQueriesEXT)
#define glGenRenderbuffers (glad_gles2_context.GenRenderbuffers)
#define glGenSamplers (glad_gles2_context.GenSamplers)
#define glGenSemaphoresEXT (glad_gles2_context.GenSemaphoresEXT)
#define glGenTextures (glad_gles2_context.GenTextures)
#define glGenTransformFeedbacks (glad_gles2_context.GenTransformFeedbacks)
#define glGenVertexArrays (glad_gles2_context.GenVertexArrays)
#define glGenVertexArraysOES (glad_gles2_context.GenVertexArraysOES)
#define glGenerateMipmap (glad_gles2_context.GenerateMipmap)
#define glGetActiveAttrib (glad_gles2_context.GetActiveAttrib)
#define glGetActiveUniform (glad_gles2_context.GetActiveUniform)
#define glGetActiveUniformBlockName (glad_gles2_context.GetActiveUniformBlockName)
#define glGetActiveUniformBlockiv (glad_gles2_context.GetActiveUniformBlockiv)
#define glGetActiveUniformsiv (glad_gles2_context.GetActiveUniformsiv)
#define glGetAttachedShaders (glad_gles2_context.GetAttachedShaders)
#define glGetAttribLocation (glad_gles2_context.GetAttribLocation)
#define glGetBooleani_v (glad_gles2_context.GetBooleani_v)
#define glGetBooleanv (glad_gles2_context.GetBooleanv)
#define glGetBufferParameteri64v (glad_gles2_context.GetBufferParameteri64v)
#define glGetBufferParameteriv (glad_gles2_context.GetBufferParameteriv)
#define glGetBufferPointerv (glad_gles2_context.GetBufferPointerv)
#define glGetBufferPointervOES (glad_gles2_context.GetBufferPointervOES)
#define glGetCoverageModulationTableNV (glad_gles2_context.GetCoverageModulationTableNV)
#define glGetDebugMessageLog (glad_gles2_context.GetDebugMessageLog)
#define glGetDebugMessageLogKHR (glad_gles2_context.GetDebugMessageLogKHR)
#define glGetDriverControlStringQCOM (glad_gles2_context.GetDriverControlStringQCOM)
#define glGetDriverControlsQCOM (glad_gles2_context.GetDriverControlsQCOM)
#define glGetError (glad_gles2_context.GetError)
#define glGetFenceivNV (glad_gles2_context.GetFenceivNV)
#define glGetFirstPerfQueryIdINTEL (glad_gles2_context.GetFirstPerfQueryIdINTEL)
#define glGetFloati_vNV (glad_gles2_context.GetFloati_vNV)
#define glGetFloati_vOES (glad_gles2_context.GetFloati_vOES)
#define glGetFloatv (glad_gles2_context.GetFloatv)
#define glGetFragDataIndexEXT (glad_gles2_context.GetFragDataIndexEXT)
#define glGetFragDataLocation (glad_gles2_context.GetFragDataLocation)
#define glGetFramebufferAttachmentParameteriv (glad_gles2_context.GetFramebufferAttachmentParameteriv)
#define glGetFramebufferParameteriv (glad_gles2_context.GetFramebufferParameteriv)
#define glGetFramebufferParameterivMESA (glad_gles2_context.GetFramebufferParameterivMESA)
#define glGetFramebufferPixelLocalStorageSizeEXT (glad_gles2_context.GetFramebufferPixelLocalStorageSizeEXT)
#define glGetGraphicsResetStatus (glad_gles2_context.GetGraphicsResetStatus)
#define glGetGraphicsResetStatusEXT (glad_gles2_context.GetGraphicsResetStatusEXT)
#define glGetGraphicsResetStatusKHR (glad_gles2_context.GetGraphicsResetStatusKHR)
#define glGetImageHandleNV (glad_gles2_context.GetImageHandleNV)
#define glGetInteger64i_v (glad_gles2_context.GetInteger64i_v)
#define glGetInteger64v (glad_gles2_context.GetInteger64v)
#define glGetInteger64vAPPLE (glad_gles2_context.GetInteger64vAPPLE)
#define glGetInteger64vEXT (glad_gles2_context.GetInteger64vEXT)
#define glGetIntegeri_v (glad_gles2_context.GetIntegeri_v)
#define glGetIntegeri_vEXT (glad_gles2_context.GetIntegeri_vEXT)
#define glGetIntegerv (glad_gles2_context.GetIntegerv)
#define glGetInternalformatSampleivNV (glad_gles2_context.GetInternalformatSampleivNV)
#define glGetInternalformativ (glad_gles2_context.GetInternalformativ)
#define glGetMemoryObjectDetachedResourcesuivNV (glad_gles2_context.GetMemoryObjectDetachedResourcesuivNV)
#define glGetMemoryObjectParameterivEXT (glad_gles2_context.GetMemoryObjectParameterivEXT)
#define glGetMultisamplefv (glad_gles2_context.GetMultisamplefv)
#define glGetNextPerfQueryIdINTEL (glad_gles2_context.GetNextPerfQueryIdINTEL)
#define glGetObjectLabel (glad_gles2_context.GetObjectLabel)
#define glGetObjectLabelEXT (glad_gles2_context.GetObjectLabelEXT)
#define glGetObjectLabelKHR (glad_gles2_context.GetObjectLabelKHR)
#define glGetObjectPtrLabel (glad_gles2_context.GetObjectPtrLabel)
#define glGetObjectPtrLabelKHR (glad_gles2_context.GetObjectPtrLabelKHR)
#define glGetPathCommandsNV (glad_gles2_context.GetPathCommandsNV)
#define glGetPathCoordsNV (glad_gles2_context.GetPathCoordsNV)
#define glGetPathDashArrayNV (glad_gles2_context.GetPathDashArrayNV)
#define glGetPathLengthNV (glad_gles2_context.GetPathLengthNV)
#define glGetPathMetricRangeNV (glad_gles2_context.GetPathMetricRangeNV)
#define glGetPathMetricsNV (glad_gles2_context.GetPathMetricsNV)
#define glGetPathParameterfvNV (glad_gles2_context.GetPathParameterfvNV)
#define glGetPathParameterivNV (glad_gles2_context.GetPathParameterivNV)
#define glGetPathSpacingNV (glad_gles2_context.GetPathSpacingNV)
#define glGetPerfCounterInfoINTEL (glad_gles2_context.GetPerfCounterInfoINTEL)
#define glGetPerfMonitorCounterDataAMD (glad_gles2_context.GetPerfMonitorCounterDataAMD)
#define glGetPerfMonitorCounterInfoAMD (glad_gles2_context.GetPerfMonitorCounterInfoAMD)
#define glGetPerfMonitorCounterStringAMD (glad_gles2_context.GetPerfMonitorCounterStringAMD)
#define glGetPerfMonitorCountersAMD (glad_gles2_context.GetPerfMonitorCountersAMD)
#define glGetPerfMonitorGroupStringAMD (glad_gles2_context.GetPerfMonitorGroupStringAMD)
#define glGetPerfMonitorGroupsAMD (glad_gles2_context.GetPerfMonitorGroupsAMD)
#define glGetPerfQueryDataINTEL (glad_gles2_context.GetPerfQueryDataINTEL)
#define glGetPerfQueryIdByNameINTEL (glad_gles2_context.GetPerfQueryIdByNameINTEL)
#define glGetPerfQueryInfoINTEL (glad_gles2_context.GetPerfQueryInfoINTEL)
#define glGetPointerv (glad_gles2_context.GetPointerv)
#define glGetPointervKHR (glad_gles2_context.GetPointervKHR)
#define glGetProgramBinary (glad_gles2_context.GetProgramBinary)
#define glGetProgramBinaryOES (glad_gles2_context.GetProgramBinaryOES)
#define glGetProgramInfoLog (glad_gles2_context.GetProgramInfoLog)
#define glGetProgramInterfaceiv (glad_gles2_context.GetProgramInterfaceiv)
#define glGetProgramPipelineInfoLog (glad_gles2_context.GetProgramPipelineInfoLog)
#define glGetProgramPipelineInfoLogEXT (glad_gles2_context.GetProgramPipelineInfoLogEXT)
#define glGetProgramPipelineiv (glad_gles2_context.GetProgramPipelineiv)
#define glGetProgramPipelineivEXT (glad_gles2_context.GetProgramPipelineivEXT)
#define glGetProgramResourceIndex (glad_gles2_context.GetProgramResourceIndex)
#define glGetProgramResourceLocation (glad_gles2_context.GetProgramResourceLocation)
#define glGetProgramResourceLocationIndexEXT (glad_gles2_context.GetProgramResourceLocationIndexEXT)
#define glGetProgramResourceName (glad_gles2_context.GetProgramResourceName)
#define glGetProgramResourcefvNV (glad_gles2_context.GetProgramResourcefvNV)
#define glGetProgramResourceiv (glad_gles2_context.GetProgramResourceiv)
#define glGetProgramiv (glad_gles2_context.GetProgramiv)
#define glGetQueryObjecti64vEXT (glad_gles2_context.GetQueryObjecti64vEXT)
#define glGetQueryObjectivEXT (glad_gles2_context.GetQueryObjectivEXT)
#define glGetQueryObjectui64vEXT (glad_gles2_context.GetQueryObjectui64vEXT)
#define glGetQueryObjectuiv (glad_gles2_context.GetQueryObjectuiv)
#define glGetQueryObjectuivEXT (glad_gles2_context.GetQueryObjectuivEXT)
#define glGetQueryiv (glad_gles2_context.GetQueryiv)
#define glGetQueryivEXT (glad_gles2_context.GetQueryivEXT)
#define glGetRenderbufferParameteriv (glad_gles2_context.GetRenderbufferParameteriv)
#define glGetSamplerParameterIiv (glad_gles2_context.GetSamplerParameterIiv)
#define glGetSamplerParameterIivEXT (glad_gles2_context.GetSamplerParameterIivEXT)
#define glGetSamplerParameterIivOES (glad_gles2_context.GetSamplerParameterIivOES)
#define glGetSamplerParameterIuiv (glad_gles2_context.GetSamplerParameterIuiv)
#define glGetSamplerParameterIuivEXT (glad_gles2_context.GetSamplerParameterIuivEXT)
#define glGetSamplerParameterIuivOES (glad_gles2_context.GetSamplerParameterIuivOES)
#define glGetSamplerParameterfv (glad_gles2_context.GetSamplerParameterfv)
#define glGetSamplerParameteriv (glad_gles2_context.GetSamplerParameteriv)
#define glGetSemaphoreParameterivNV (glad_gles2_context.GetSemaphoreParameterivNV)
#define glGetSemaphoreParameterui64vEXT (glad_gles2_context.GetSemaphoreParameterui64vEXT)
#define glGetShaderInfoLog (glad_gles2_context.GetShaderInfoLog)
#define glGetShaderPrecisionFormat (glad_gles2_context.GetShaderPrecisionFormat)
#define glGetShaderSource (glad_gles2_context.GetShaderSource)
#define glGetShaderiv (glad_gles2_context.GetShaderiv)
#define glGetShadingRateImagePaletteNV (glad_gles2_context.GetShadingRateImagePaletteNV)
#define glGetShadingRateSampleLocationivNV (glad_gles2_context.GetShadingRateSampleLocationivNV)
#define glGetString (glad_gles2_context.GetString)
#define glGetStringi (glad_gles2_context.GetStringi)
#define glGetSynciv (glad_gles2_context.GetSynciv)
#define glGetSyncivAPPLE (glad_gles2_context.GetSyncivAPPLE)
#define glGetTexLevelParameterfv (glad_gles2_context.GetTexLevelParameterfv)
#define glGetTexLevelParameteriv (glad_gles2_context.GetTexLevelParameteriv)
#define glGetTexParameterIiv (glad_gles2_context.GetTexParameterIiv)
#define glGetTexParameterIivEXT (glad_gles2_context.GetTexParameterIivEXT)
#define glGetTexParameterIivOES (glad_gles2_context.GetTexParameterIivOES)
#define glGetTexParameterIuiv (glad_gles2_context.GetTexParameterIuiv)
#define glGetTexParameterIuivEXT (glad_gles2_context.GetTexParameterIuivEXT)
#define glGetTexParameterIuivOES (glad_gles2_context.GetTexParameterIuivOES)
#define glGetTexParameterfv (glad_gles2_context.GetTexParameterfv)
#define glGetTexParameteriv (glad_gles2_context.GetTexParameteriv)
#define glGetTextureHandleIMG (glad_gles2_context.GetTextureHandleIMG)
#define glGetTextureHandleNV (glad_gles2_context.GetTextureHandleNV)
#define glGetTextureSamplerHandleIMG (glad_gles2_context.GetTextureSamplerHandleIMG)
#define glGetTextureSamplerHandleNV (glad_gles2_context.GetTextureSamplerHandleNV)
#define glGetTransformFeedbackVarying (glad_gles2_context.GetTransformFeedbackVarying)
#define glGetTranslatedShaderSourceANGLE (glad_gles2_context.GetTranslatedShaderSourceANGLE)
#define glGetUniformBlockIndex (glad_gles2_context.GetUniformBlockIndex)
#define glGetUniformIndices (glad_gles2_context.GetUniformIndices)
#define glGetUniformLocation (glad_gles2_context.GetUniformLocation)
#define glGetUniformfv (glad_gles2_context.GetUniformfv)
#define glGetUniformi64vNV (glad_gles2_context.GetUniformi64vNV)
#define glGetUniformiv (glad_gles2_context.GetUniformiv)
#define glGetUniformuiv (glad_gles2_context.GetUniformuiv)
#define glGetUnsignedBytei_vEXT (glad_gles2_context.GetUnsignedBytei_vEXT)
#define glGetUnsignedBytevEXT (glad_gles2_context.GetUnsignedBytevEXT)
#define glGetVertexAttribIiv (glad_gles2_context.GetVertexAttribIiv)
#define glGetVertexAttribIuiv (glad_gles2_context.GetVertexAttribIuiv)
#define glGetVertexAttribPointerv (glad_gles2_context.GetVertexAttribPointerv)
#define glGetVertexAttribfv (glad_gles2_context.GetVertexAttribfv)
#define glGetVertexAttribiv (glad_gles2_context.GetVertexAttribiv)
#define glGetVkProcAddrNV (glad_gles2_context.GetVkProcAddrNV)
#define glGetnUniformfv (glad_gles2_context.GetnUniformfv)
#define glGetnUniformfvEXT (glad_gles2_context.GetnUniformfvEXT)
#define glGetnUniformfvKHR (glad_gles2_context.GetnUniformfvKHR)
#define glGetnUniformiv (glad_gles2_context.GetnUniformiv)
#define glGetnUniformivEXT (glad_gles2_context.GetnUniformivEXT)
#define glGetnUniformivKHR (glad_gles2_context.GetnUniformivKHR)
#define glGetnUniformuiv (glad_gles2_context.GetnUniformuiv)
#define glGetnUniformuivKHR (glad_gles2_context.GetnUniformuivKHR)
#define glHint (glad_gles2_context.Hint)
#define glImportMemoryFdEXT (glad_gles2_context.ImportMemoryFdEXT)
#define glImportMemoryWin32HandleEXT (glad_gles2_context.ImportMemoryWin32HandleEXT)
#define glImportMemoryWin32NameEXT (glad_gles2_context.ImportMemoryWin32NameEXT)
#define glImportSemaphoreFdEXT (glad_gles2_context.ImportSemaphoreFdEXT)
#define glImportSemaphoreWin32HandleEXT (glad_gles2_context.ImportSemaphoreWin32HandleEXT)
#define glImportSemaphoreWin32NameEXT (glad_gles2_context.ImportSemaphoreWin32NameEXT)
#define glInsertEventMarkerEXT (glad_gles2_context.InsertEventMarkerEXT)
#define glInterpolatePathsNV (glad_gles2_context.InterpolatePathsNV)
#define glInvalidateFramebuffer (glad_gles2_context.InvalidateFramebuffer)
#define glInvalidateSubFramebuffer (glad_gles2_context.InvalidateSubFramebuffer)
#define glIsBuffer (glad_gles2_context.IsBuffer)
#define glIsEnabled (glad_gles2_context.IsEnabled)
#define glIsEnabledi (glad_gles2_context.IsEnabledi)
#define glIsEnablediEXT (glad_gles2_context.IsEnablediEXT)
#define glIsEnablediNV (glad_gles2_context.IsEnablediNV)
#define glIsEnablediOES (glad_gles2_context.IsEnablediOES)
#define glIsFenceNV (glad_gles2_context.IsFenceNV)
#define glIsFramebuffer (glad_gles2_context.IsFramebuffer)
#define glIsImageHandleResidentNV (glad_gles2_context.IsImageHandleResidentNV)
#define glIsMemoryObjectEXT (glad_gles2_context.IsMemoryObjectEXT)
#define glIsPathNV (glad_gles2_context.IsPathNV)
#define glIsPointInFillPathNV (glad_gles2_context.IsPointInFillPathNV)
#define glIsPointInStrokePathNV (glad_gles2_context.IsPointInStrokePathNV)
#define glIsProgram (glad_gles2_context.IsProgram)
#define glIsProgramPipeline (glad_gles2_context.IsProgramPipeline)
#define glIsProgramPipelineEXT (glad_gles2_context.IsProgramPipelineEXT)
#define glIsQuery (glad_gles2_context.IsQuery)
#define glIsQueryEXT (glad_gles2_context.IsQueryEXT)
#define glIsRenderbuffer (glad_gles2_context.IsRenderbuffer)
#define glIsSampler (glad_gles2_context.IsSampler)
#define glIsSemaphoreEXT (glad_gles2_context.IsSemaphoreEXT)
#define glIsShader (glad_gles2_context.IsShader)
#define glIsSync (glad_gles2_context.IsSync)
#define glIsSyncAPPLE (glad_gles2_context.IsSyncAPPLE)
#define glIsTexture (glad_gles2_context.IsTexture)
#define glIsTextureHandleResidentNV (glad_gles2_context.IsTextureHandleResidentNV)
#define glIsTransformFeedback (glad_gles2_context.IsTransformFeedback)
#define glIsVertexArray (glad_gles2_context.IsVertexArray)
#define glIsVertexArrayOES (glad_gles2_context.IsVertexArrayOES)
#define glLabelObjectEXT (glad_gles2_context.LabelObjectEXT)
#define glLineWidth (glad_gles2_context.LineWidth)
#define glLinkProgram (glad_gles2_context.LinkProgram)
#define glMakeImageHandleNonResidentNV (glad_gles2_context.MakeImageHandleNonResidentNV)
#define glMakeImageHandleResidentNV (glad_gles2_context.MakeImageHandleResidentNV)
#define glMakeTextureHandleNonResidentNV (glad_gles2_context.MakeTextureHandleNonResidentNV)
#define glMakeTextureHandleResidentNV (glad_gles2_context.MakeTextureHandleResidentNV)
#define glMapBufferOES (glad_gles2_context.MapBufferOES)
#define glMapBufferRange (glad_gles2_context.MapBufferRange)
#define glMapBufferRangeEXT (glad_gles2_context.MapBufferRangeEXT)
#define glMatrixFrustumEXT (glad_gles2_context.MatrixFrustumEXT)
#define glMatrixLoad3x2fNV (glad_gles2_context.MatrixLoad3x2fNV)
#define glMatrixLoad3x3fNV (glad_gles2_context.MatrixLoad3x3fNV)
#define glMatrixLoadIdentityEXT (glad_gles2_context.MatrixLoadIdentityEXT)
#define glMatrixLoadTranspose3x3fNV (glad_gles2_context.MatrixLoadTranspose3x3fNV)
#define glMatrixLoadTransposedEXT (glad_gles2_context.MatrixLoadTransposedEXT)
#define glMatrixLoadTransposefEXT (glad_gles2_context.MatrixLoadTransposefEXT)
#define glMatrixLoaddEXT (glad_gles2_context.MatrixLoaddEXT)
#define glMatrixLoadfEXT (glad_gles2_context.MatrixLoadfEXT)
#define glMatrixMult3x2fNV (glad_gles2_context.MatrixMult3x2fNV)
#define glMatrixMult3x3fNV (glad_gles2_context.MatrixMult3x3fNV)
#define glMatrixMultTranspose3x3fNV (glad_gles2_context.MatrixMultTranspose3x3fNV)
#define glMatrixMultTransposedEXT (glad_gles2_context.MatrixMultTransposedEXT)
#define glMatrixMultTransposefEXT (glad_gles2_context.MatrixMultTransposefEXT)
#define glMatrixMultdEXT (glad_gles2_context.MatrixMultdEXT)
#define glMatrixMultfEXT (glad_gles2_context.MatrixMultfEXT)
#define glMatrixOrthoEXT (glad_gles2_context.MatrixOrthoEXT)
#define glMatrixPopEXT (glad_gles2_context.MatrixPopEXT)
#define glMatrixPushEXT (glad_gles2_context.MatrixPushEXT)
#define glMatrixRotatedEXT (glad_gles2_context.MatrixRotatedEXT)
#define glMatrixRotatefEXT (glad_gles2_context.MatrixRotatefEXT)
#define glMatrixScaledEXT (glad_gles2_context.MatrixScaledEXT)
#define glMatrixScalefEXT (glad_gles2_context.MatrixScalefEXT)
#define glMatrixTranslatedEXT (glad_gles2_context.MatrixTranslatedEXT)
#define glMatrixTranslatefEXT (glad_gles2_context.MatrixTranslatefEXT)
#define glMaxShaderCompilerThreadsKHR (glad_gles2_context.MaxShaderCompilerThreadsKHR)
#define glMemoryBarrier (glad_gles2_context.MemoryBarrier)
#define glMemoryBarrierByRegion (glad_gles2_context.MemoryBarrierByRegion)
#define glMemoryObjectParameterivEXT (glad_gles2_context.MemoryObjectParameterivEXT)
#define glMinSampleShading (glad_gles2_context.MinSampleShading)
#define glMinSampleShadingOES (glad_gles2_context.MinSampleShadingOES)
#define glMultiDrawArraysEXT (glad_gles2_context.MultiDrawArraysEXT)
#define glMultiDrawArraysIndirectEXT (glad_gles2_context.MultiDrawArraysIndirectEXT)
#define glMultiDrawElementsBaseVertexEXT (glad_gles2_context.MultiDrawElementsBaseVertexEXT)
#define glMultiDrawElementsEXT (glad_gles2_context.MultiDrawElementsEXT)
#define glMultiDrawElementsIndirectEXT (glad_gles2_context.MultiDrawElementsIndirectEXT)
#define glMultiDrawMeshTasksIndirectCountNV (glad_gles2_context.MultiDrawMeshTasksIndirectCountNV)
#define glMultiDrawMeshTasksIndirectNV (glad_gles2_context.MultiDrawMeshTasksIndirectNV)
#define glNamedBufferAttachMemoryNV (glad_gles2_context.NamedBufferAttachMemoryNV)
#define glNamedBufferPageCommitmentMemNV (glad_gles2_context.NamedBufferPageCommitmentMemNV)
#define glNamedBufferStorageExternalEXT (glad_gles2_context.NamedBufferStorageExternalEXT)
#define glNamedBufferStorageMemEXT (glad_gles2_context.NamedBufferStorageMemEXT)
#define glNamedFramebufferSampleLocationsfvNV (glad_gles2_context.NamedFramebufferSampleLocationsfvNV)
#define glNamedRenderbufferStorageMultisampleAdvancedAMD (glad_gles2_context.NamedRenderbufferStorageMultisampleAdvancedAMD)
#define glObjectLabel (glad_gles2_context.ObjectLabel)
#define glObjectLabelKHR (glad_gles2_context.ObjectLabelKHR)
#define glObjectPtrLabel (glad_gles2_context.ObjectPtrLabel)
#define glObjectPtrLabelKHR (glad_gles2_context.ObjectPtrLabelKHR)
#define glPatchParameteri (glad_gles2_context.PatchParameteri)
#define glPatchParameteriEXT (glad_gles2_context.PatchParameteriEXT)
#define glPatchParameteriOES (glad_gles2_context.PatchParameteriOES)
#define glPathCommandsNV (glad_gles2_context.PathCommandsNV)
#define glPathCoordsNV (glad_gles2_context.PathCoordsNV)
#define glPathCoverDepthFuncNV (glad_gles2_context.PathCoverDepthFuncNV)
#define glPathDashArrayNV (glad_gles2_context.PathDashArrayNV)
#define glPathGlyphIndexArrayNV (glad_gles2_context.PathGlyphIndexArrayNV)
#define glPathGlyphIndexRangeNV (glad_gles2_context.PathGlyphIndexRangeNV)
#define glPathGlyphRangeNV (glad_gles2_context.PathGlyphRangeNV)
#define glPathGlyphsNV (glad_gles2_context.PathGlyphsNV)
#define glPathMemoryGlyphIndexArrayNV (glad_gles2_context.PathMemoryGlyphIndexArrayNV)
#define glPathParameterfNV (glad_gles2_context.PathParameterfNV)
#define glPathParameterfvNV (glad_gles2_context.PathParameterfvNV)
#define glPathParameteriNV (glad_gles2_context.PathParameteriNV)
#define glPathParameterivNV (glad_gles2_context.PathParameterivNV)
#define glPathStencilDepthOffsetNV (glad_gles2_context.PathStencilDepthOffsetNV)
#define glPathStencilFuncNV (glad_gles2_context.PathStencilFuncNV)
#define glPathStringNV (glad_gles2_context.PathStringNV)
#define glPathSubCommandsNV (glad_gles2_context.PathSubCommandsNV)
#define glPathSubCoordsNV (glad_gles2_context.PathSubCoordsNV)
#define glPauseTransformFeedback (glad_gles2_context.PauseTransformFeedback)
#define glPixelStorei (glad_gles2_context.PixelStorei)
#define glPointAlongPathNV (glad_gles2_context.PointAlongPathNV)
#define glPolygonModeNV (glad_gles2_context.PolygonModeNV)
#define glPolygonOffset (glad_gles2_context.PolygonOffset)
#define glPolygonOffsetClampEXT (glad_gles2_context.PolygonOffsetClampEXT)
#define glPopDebugGroup (glad_gles2_context.PopDebugGroup)
#define glPopDebugGroupKHR (glad_gles2_context.PopDebugGroupKHR)
#define glPopGroupMarkerEXT (glad_gles2_context.PopGroupMarkerEXT)
#define glPrimitiveBoundingBox (glad_gles2_context.PrimitiveBoundingBox)
#define glPrimitiveBoundingBoxEXT (glad_gles2_context.PrimitiveBoundingBoxEXT)
#define glPrimitiveBoundingBoxOES (glad_gles2_context.PrimitiveBoundingBoxOES)
#define glProgramBinary (glad_gles2_context.ProgramBinary)
#define glProgramBinaryOES (glad_gles2_context.ProgramBinaryOES)
#define glProgramParameteri (glad_gles2_context.ProgramParameteri)
#define glProgramParameteriEXT (glad_gles2_context.ProgramParameteriEXT)
#define glProgramPathFragmentInputGenNV (glad_gles2_context.ProgramPathFragmentInputGenNV)
#define glProgramUniform1f (glad_gles2_context.ProgramUniform1f)
#define glProgramUniform1fEXT (glad_gles2_context.ProgramUniform1fEXT)
#define glProgramUniform1fv (glad_gles2_context.ProgramUniform1fv)
#define glProgramUniform1fvEXT (glad_gles2_context.ProgramUniform1fvEXT)
#define glProgramUniform1i (glad_gles2_context.ProgramUniform1i)
#define glProgramUniform1i64NV (glad_gles2_context.ProgramUniform1i64NV)
#define glProgramUniform1i64vNV (glad_gles2_context.ProgramUniform1i64vNV)
#define glProgramUniform1iEXT (glad_gles2_context.ProgramUniform1iEXT)
#define glProgramUniform1iv (glad_gles2_context.ProgramUniform1iv)
#define glProgramUniform1ivEXT (glad_gles2_context.ProgramUniform1ivEXT)
#define glProgramUniform1ui (glad_gles2_context.ProgramUniform1ui)
#define glProgramUniform1ui64NV (glad_gles2_context.ProgramUniform1ui64NV)
#define glProgramUniform1ui64vNV (glad_gles2_context.ProgramUniform1ui64vNV)
#define glProgramUniform1uiEXT (glad_gles2_context.ProgramUniform1uiEXT)
#define glProgramUniform1uiv (glad_gles2_context.ProgramUniform1uiv)
#define glProgramUniform1uivEXT (glad_gles2_context.ProgramUniform1uivEXT)
#define glProgramUniform2f (glad_gles2_context.ProgramUniform2f)
#define glProgramUniform2fEXT (glad_gles2_context.ProgramUniform2fEXT)
#define glProgramUniform2fv (glad_gles2_context.ProgramUniform2fv)
#define glProgramUniform2fvEXT (glad_gles2_context.ProgramUniform2fvEXT)
#define glProgramUniform2i (glad_gles2_context.ProgramUniform2i)
#define glProgramUniform2i64NV (glad_gles2_context.ProgramUniform2i64NV)
#define glProgramUniform2i64vNV (glad_gles2_context.ProgramUniform2i64vNV)
#define glProgramUniform2iEXT (glad_gles2_context.ProgramUniform2iEXT)
#define glProgramUniform2iv (glad_gles2_context.ProgramUniform2iv)
#define glProgramUniform2ivEXT (glad_gles2_context.ProgramUniform2ivEXT)
#define glProgramUniform2ui (glad_gles2_context.ProgramUniform2ui)
#define glProgramUniform2ui64NV (glad_gles2_context.ProgramUniform2ui64NV)
#define glProgramUniform2ui64vNV (glad_gles2_context.ProgramUniform2ui64vNV)
#define glProgramUniform2uiEXT (glad_gles2_context.ProgramUniform2uiEXT)
#define glProgramUniform2uiv (glad_gles2_context.ProgramUniform2uiv)
#define glProgramUniform2uivEXT (glad_gles2_context.ProgramUniform2uivEXT)
#define glProgramUniform3f (glad_gles2_context.ProgramUniform3f)
#define glProgramUniform3fEXT (glad_gles2_context.ProgramUniform3fEXT)
#define glProgramUniform3fv (glad_gles2_context.ProgramUniform3fv)
#define glProgramUniform3fvEXT (glad_gles2_context.ProgramUniform3fvEXT)
#define glProgramUniform3i (glad_gles2_context.ProgramUniform3i)
#define glProgramUniform3i64NV (glad_gles2_context.ProgramUniform3i64NV)
#define glProgramUniform3i64vNV (glad_gles2_context.ProgramUniform3i64vNV)
#define glProgramUniform3iEXT (glad_gles2_context.ProgramUniform3iEXT)
#define glProgramUniform3iv (glad_gles2_context.ProgramUniform3iv)
#define glProgramUniform3ivEXT (glad_gles2_context.ProgramUniform3ivEXT)
#define glProgramUniform3ui (glad_gles2_context.ProgramUniform3ui)
#define glProgramUniform3ui64NV (glad_gles2_context.ProgramUniform3ui64NV)
#define glProgramUniform3ui64vNV (glad_gles2_context.ProgramUniform3ui64vNV)
#define glProgramUniform3uiEXT (glad_gles2_context.ProgramUniform3uiEXT)
#define glProgramUniform3uiv (glad_gles2_context.ProgramUniform3uiv)
#define glProgramUniform3uivEXT (glad_gles2_context.ProgramUniform3uivEXT)
#define glProgramUniform4f (glad_gles2_context.ProgramUniform4f)
#define glProgramUniform4fEXT (glad_gles2_context.ProgramUniform4fEXT)
#define glProgramUniform4fv (glad_gles2_context.ProgramUniform4fv)
#define glProgramUniform4fvEXT (glad_gles2_context.ProgramUniform4fvEXT)
#define glProgramUniform4i (glad_gles2_context.ProgramUniform4i)
#define glProgramUniform4i64NV (glad_gles2_context.ProgramUniform4i64NV)
#define glProgramUniform4i64vNV (glad_gles2_context.ProgramUniform4i64vNV)
#define glProgramUniform4iEXT (glad_gles2_context.ProgramUniform4iEXT)
#define glProgramUniform4iv (glad_gles2_context.ProgramUniform4iv)
#define glProgramUniform4ivEXT (glad_gles2_context.ProgramUniform4ivEXT)
#define glProgramUniform4ui (glad_gles2_context.ProgramUniform4ui)
#define glProgramUniform4ui64NV (glad_gles2_context.ProgramUniform4ui64NV)
#define glProgramUniform4ui64vNV (glad_gles2_context.ProgramUniform4ui64vNV)
#define glProgramUniform4uiEXT (glad_gles2_context.ProgramUniform4uiEXT)
#define glProgramUniform4uiv (glad_gles2_context.ProgramUniform4uiv)
#define glProgramUniform4uivEXT (glad_gles2_context.ProgramUniform4uivEXT)
#define glProgramUniformHandleui64IMG (glad_gles2_context.ProgramUniformHandleui64IMG)
#define glProgramUniformHandleui64NV (glad_gles2_context.ProgramUniformHandleui64NV)
#define glProgramUniformHandleui64vIMG (glad_gles2_context.ProgramUniformHandleui64vIMG)
#define glProgramUniformHandleui64vNV (glad_gles2_context.ProgramUniformHandleui64vNV)
#define glProgramUniformMatrix2fv (glad_gles2_context.ProgramUniformMatrix2fv)
#define glProgramUniformMatrix2fvEXT (glad_gles2_context.ProgramUniformMatrix2fvEXT)
#define glProgramUniformMatrix2x3fv (glad_gles2_context.ProgramUniformMatrix2x3fv)
#define glProgramUniformMatrix2x3fvEXT (glad_gles2_context.ProgramUniformMatrix2x3fvEXT)
#define glProgramUniformMatrix2x4fv (glad_gles2_context.ProgramUniformMatrix2x4fv)
#define glProgramUniformMatrix2x4fvEXT (glad_gles2_context.ProgramUniformMatrix2x4fvEXT)
#define glProgramUniformMatrix3fv (glad_gles2_context.ProgramUniformMatrix3fv)
#define glProgramUniformMatrix3fvEXT (glad_gles2_context.ProgramUniformMatrix3fvEXT)
#define glProgramUniformMatrix3x2fv (glad_gles2_context.ProgramUniformMatrix3x2fv)
#define glProgramUniformMatrix3x2fvEXT (glad_gles2_context.ProgramUniformMatrix3x2fvEXT)
#define glProgramUniformMatrix3x4fv (glad_gles2_context.ProgramUniformMatrix3x4fv)
#define glProgramUniformMatrix3x4fvEXT (glad_gles2_context.ProgramUniformMatrix3x4fvEXT)
#define glProgramUniformMatrix4fv (glad_gles2_context.ProgramUniformMatrix4fv)
#define glProgramUniformMatrix4fvEXT (glad_gles2_context.ProgramUniformMatrix4fvEXT)
#define glProgramUniformMatrix4x2fv (glad_gles2_context.ProgramUniformMatrix4x2fv)
#define glProgramUniformMatrix4x2fvEXT (glad_gles2_context.ProgramUniformMatrix4x2fvEXT)
#define glProgramUniformMatrix4x3fv (glad_gles2_context.ProgramUniformMatrix4x3fv)
#define glProgramUniformMatrix4x3fvEXT (glad_gles2_context.ProgramUniformMatrix4x3fvEXT)
#define glPushDebugGroup (glad_gles2_context.PushDebugGroup)
#define glPushDebugGroupKHR (glad_gles2_context.PushDebugGroupKHR)
#define glPushGroupMarkerEXT (glad_gles2_context.PushGroupMarkerEXT)
#define glQueryCounterEXT (glad_gles2_context.QueryCounterEXT)
#define glRasterSamplesEXT (glad_gles2_context.RasterSamplesEXT)
#define glReadBuffer (glad_gles2_context.ReadBuffer)
#define glReadBufferIndexedEXT (glad_gles2_context.ReadBufferIndexedEXT)
#define glReadBufferNV (glad_gles2_context.ReadBufferNV)
#define glReadPixels (glad_gles2_context.ReadPixels)
#define glReadnPixels (glad_gles2_context.ReadnPixels)
#define glReadnPixelsEXT (glad_gles2_context.ReadnPixelsEXT)
#define glReadnPixelsKHR (glad_gles2_context.ReadnPixelsKHR)
#define glReleaseKeyedMutexWin32EXT (glad_gles2_context.ReleaseKeyedMutexWin32EXT)
#define glReleaseShaderCompiler (glad_gles2_context.ReleaseShaderCompiler)
#define glRenderbufferStorage (glad_gles2_context.RenderbufferStorage)
#define glRenderbufferStorageMultisample (glad_gles2_context.RenderbufferStorageMultisample)
#define glRenderbufferStorageMultisampleANGLE (glad_gles2_context.RenderbufferStorageMultisampleANGLE)
#define glRenderbufferStorageMultisampleAPPLE (glad_gles2_context.RenderbufferStorageMultisampleAPPLE)
#define glRenderbufferStorageMultisampleAdvancedAMD (glad_gles2_context.RenderbufferStorageMultisampleAdvancedAMD)
#define glRenderbufferStorageMultisampleEXT (glad_gles2_context.RenderbufferStorageMultisampleEXT)
#define glRenderbufferStorageMultisampleIMG (glad_gles2_context.RenderbufferStorageMultisampleIMG)
#define glRenderbufferStorageMultisampleNV (glad_gles2_context.RenderbufferStorageMultisampleNV)
#define glResetMemoryObjectParameterNV (glad_gles2_context.ResetMemoryObjectParameterNV)
#define glResolveDepthValuesNV (glad_gles2_context.ResolveDepthValuesNV)
#define glResolveMultisampleFramebufferAPPLE (glad_gles2_context.ResolveMultisampleFramebufferAPPLE)
#define glResumeTransformFeedback (glad_gles2_context.ResumeTransformFeedback)
#define glSampleCoverage (glad_gles2_context.SampleCoverage)
#define glSampleMaski (glad_gles2_context.SampleMaski)
#define glSamplerParameterIiv (glad_gles2_context.SamplerParameterIiv)
#define glSamplerParameterIivEXT (glad_gles2_context.SamplerParameterIivEXT)
#define glSamplerParameterIivOES (glad_gles2_context.SamplerParameterIivOES)
#define glSamplerParameterIuiv (glad_gles2_context.SamplerParameterIuiv)
#define glSamplerParameterIuivEXT (glad_gles2_context.SamplerParameterIuivEXT)
#define glSamplerParameterIuivOES (glad_gles2_context.SamplerParameterIuivOES)
#define glSamplerParameterf (glad_gles2_context.SamplerParameterf)
#define glSamplerParameterfv (glad_gles2_context.SamplerParameterfv)
#define glSamplerParameteri (glad_gles2_context.SamplerParameteri)
#define glSamplerParameteriv (glad_gles2_context.SamplerParameteriv)
#define glScissor (glad_gles2_context.Scissor)
#define glScissorArrayvNV (glad_gles2_context.ScissorArrayvNV)
#define glScissorArrayvOES (glad_gles2_context.ScissorArrayvOES)
#define glScissorExclusiveArrayvNV (glad_gles2_context.ScissorExclusiveArrayvNV)
#define glScissorExclusiveNV (glad_gles2_context.ScissorExclusiveNV)
#define glScissorIndexedNV (glad_gles2_context.ScissorIndexedNV)
#define glScissorIndexedOES (glad_gles2_context.ScissorIndexedOES)
#define glScissorIndexedvNV (glad_gles2_context.ScissorIndexedvNV)
#define glScissorIndexedvOES (glad_gles2_context.ScissorIndexedvOES)
#define glSelectPerfMonitorCountersAMD (glad_gles2_context.SelectPerfMonitorCountersAMD)
#define glSemaphoreParameterivNV (glad_gles2_context.SemaphoreParameterivNV)
#define glSemaphoreParameterui64vEXT (glad_gles2_context.SemaphoreParameterui64vEXT)
#define glSetFenceNV (glad_gles2_context.SetFenceNV)
#define glShaderBinary (glad_gles2_context.ShaderBinary)
#define glShaderSource (glad_gles2_context.ShaderSource)
#define glShadingRateImageBarrierNV (glad_gles2_context.ShadingRateImageBarrierNV)
#define glShadingRateImagePaletteNV (glad_gles2_context.ShadingRateImagePaletteNV)
#define glShadingRateQCOM (glad_gles2_context.ShadingRateQCOM)
#define glShadingRateSampleOrderCustomNV (glad_gles2_context.ShadingRateSampleOrderCustomNV)
#define glShadingRateSampleOrderNV (glad_gles2_context.ShadingRateSampleOrderNV)
#define glSignalSemaphoreEXT (glad_gles2_context.SignalSemaphoreEXT)
#define glSignalVkFenceNV (glad_gles2_context.SignalVkFenceNV)
#define glSignalVkSemaphoreNV (glad_gles2_context.SignalVkSemaphoreNV)
#define glStartTilingQCOM (glad_gles2_context.StartTilingQCOM)
#define glStencilFillPathInstancedNV (glad_gles2_context.StencilFillPathInstancedNV)
#define glStencilFillPathNV (glad_gles2_context.StencilFillPathNV)
#define glStencilFunc (glad_gles2_context.StencilFunc)
#define glStencilFuncSeparate (glad_gles2_context.StencilFuncSeparate)
#define glStencilMask (glad_gles2_context.StencilMask)
#define glStencilMaskSeparate (glad_gles2_context.StencilMaskSeparate)
#define glStencilOp (glad_gles2_context.StencilOp)
#define glStencilOpSeparate (glad_gles2_context.StencilOpSeparate)
#define glStencilStrokePathInstancedNV (glad_gles2_context.StencilStrokePathInstancedNV)
#define glStencilStrokePathNV (glad_gles2_context.StencilStrokePathNV)
#define glStencilThenCoverFillPathInstancedNV (glad_gles2_context.StencilThenCoverFillPathInstancedNV)
#define glStencilThenCoverFillPathNV (glad_gles2_context.StencilThenCoverFillPathNV)
#define glStencilThenCoverStrokePathInstancedNV (glad_gles2_context.StencilThenCoverStrokePathInstancedNV)
#define glStencilThenCoverStrokePathNV (glad_gles2_context.StencilThenCoverStrokePathNV)
#define glSubpixelPrecisionBiasNV (glad_gles2_context.SubpixelPrecisionBiasNV)
#define glTestFenceNV (glad_gles2_context.TestFenceNV)
#define glTexAttachMemoryNV (glad_gles2_context.TexAttachMemoryNV)
#define glTexBuffer (glad_gles2_context.TexBuffer)
#define glTexBufferEXT (glad_gles2_context.TexBufferEXT)
#define glTexBufferOES (glad_gles2_context.TexBufferOES)
#define glTexBufferRange (glad_gles2_context.TexBufferRange)
#define glTexBufferRangeEXT (glad_gles2_context.TexBufferRangeEXT)
#define glTexBufferRangeOES (glad_gles2_context.TexBufferRangeOES)
#define glTexEstimateMotionQCOM (glad_gles2_context.TexEstimateMotionQCOM)
#define glTexEstimateMotionRegionsQCOM (glad_gles2_context.TexEstimateMotionRegionsQCOM)
#define glTexImage2D (glad_gles2_context.TexImage2D)
#define glTexImage3D (glad_gles2_context.TexImage3D)
#define glTexImage3DOES (glad_gles2_context.TexImage3DOES)
#define glTexPageCommitmentEXT (glad_gles2_context.TexPageCommitmentEXT)
#define glTexPageCommitmentMemNV (glad_gles2_context.TexPageCommitmentMemNV)
#define glTexParameterIiv (glad_gles2_context.TexParameterIiv)
#define glTexParameterIivEXT (glad_gles2_context.TexParameterIivEXT)
#define glTexParameterIivOES (glad_gles2_context.TexParameterIivOES)
#define glTexParameterIuiv (glad_gles2_context.TexParameterIuiv)
#define glTexParameterIuivEXT (glad_gles2_context.TexParameterIuivEXT)
#define glTexParameterIuivOES (glad_gles2_context.TexParameterIuivOES)
#define glTexParameterf (glad_gles2_context.TexParameterf)
#define glTexParameterfv (glad_gles2_context.TexParameterfv)
#define glTexParameteri (glad_gles2_context.TexParameteri)
#define glTexParameteriv (glad_gles2_context.TexParameteriv)
#define glTexStorage1DEXT (glad_gles2_context.TexStorage1DEXT)
#define glTexStorage2D (glad_gles2_context.TexStorage2D)
#define glTexStorage2DEXT (glad_gles2_context.TexStorage2DEXT)
#define glTexStorage2DMultisample (glad_gles2_context.TexStorage2DMultisample)
#define glTexStorage3D (glad_gles2_context.TexStorage3D)
#define glTexStorage3DEXT (glad_gles2_context.TexStorage3DEXT)
#define glTexStorage3DMultisample (glad_gles2_context.TexStorage3DMultisample)
#define glTexStorage3DMultisampleOES (glad_gles2_context.TexStorage3DMultisampleOES)
#define glTexStorageMem2DEXT (glad_gles2_context.TexStorageMem2DEXT)
#define glTexStorageMem2DMultisampleEXT (glad_gles2_context.TexStorageMem2DMultisampleEXT)
#define glTexStorageMem3DEXT (glad_gles2_context.TexStorageMem3DEXT)
#define glTexStorageMem3DMultisampleEXT (glad_gles2_context.TexStorageMem3DMultisampleEXT)
#define glTexSubImage2D (glad_gles2_context.TexSubImage2D)
#define glTexSubImage3D (glad_gles2_context.TexSubImage3D)
#define glTexSubImage3DOES (glad_gles2_context.TexSubImage3DOES)
#define glTextureAttachMemoryNV (glad_gles2_context.TextureAttachMemoryNV)
#define glTextureFoveationParametersQCOM (glad_gles2_context.TextureFoveationParametersQCOM)
#define glTexturePageCommitmentMemNV (glad_gles2_context.TexturePageCommitmentMemNV)
#define glTextureStorage1DEXT (glad_gles2_context.TextureStorage1DEXT)
#define glTextureStorage2DEXT (glad_gles2_context.TextureStorage2DEXT)
#define glTextureStorage3DEXT (glad_gles2_context.TextureStorage3DEXT)
#define glTextureStorageMem2DEXT (glad_gles2_context.TextureStorageMem2DEXT)
#define glTextureStorageMem2DMultisampleEXT (glad_gles2_context.TextureStorageMem2DMultisampleEXT)
#define glTextureStorageMem3DEXT (glad_gles2_context.TextureStorageMem3DEXT)
#define glTextureStorageMem3DMultisampleEXT (glad_gles2_context.TextureStorageMem3DMultisampleEXT)
#define glTextureViewEXT (glad_gles2_context.TextureViewEXT)
#define glTextureViewOES (glad_gles2_context.TextureViewOES)
#define glTransformFeedbackVaryings (glad_gles2_context.TransformFeedbackVaryings)
#define glTransformPathNV (glad_gles2_context.TransformPathNV)
#define glUniform1f (glad_gles2_context.Uniform1f)
#define glUniform1fv (glad_gles2_context.Uniform1fv)
#define glUniform1i (glad_gles2_context.Uniform1i)
#define glUniform1i64NV (glad_gles2_context.Uniform1i64NV)
#define glUniform1i64vNV (glad_gles2_context.Uniform1i64vNV)
#define glUniform1iv (glad_gles2_context.Uniform1iv)
#define glUniform1ui (glad_gles2_context.Uniform1ui)
#define glUniform1ui64NV (glad_gles2_context.Uniform1ui64NV)
#define glUniform1ui64vNV (glad_gles2_context.Uniform1ui64vNV)
#define glUniform1uiv (glad_gles2_context.Uniform1uiv)
#define glUniform2f (glad_gles2_context.Uniform2f)
#define glUniform2fv (glad_gles2_context.Uniform2fv)
#define glUniform2i (glad_gles2_context.Uniform2i)
#define glUniform2i64NV (glad_gles2_context.Uniform2i64NV)
#define glUniform2i64vNV (glad_gles2_context.Uniform2i64vNV)
#define glUniform2iv (glad_gles2_context.Uniform2iv)
#define glUniform2ui (glad_gles2_context.Uniform2ui)
#define glUniform2ui64NV (glad_gles2_context.Uniform2ui64NV)
#define glUniform2ui64vNV (glad_gles2_context.Uniform2ui64vNV)
#define glUniform2uiv (glad_gles2_context.Uniform2uiv)
#define glUniform3f (glad_gles2_context.Uniform3f)
#define glUniform3fv (glad_gles2_context.Uniform3fv)
#define glUniform3i (glad_gles2_context.Uniform3i)
#define glUniform3i64NV (glad_gles2_context.Uniform3i64NV)
#define glUniform3i64vNV (glad_gles2_context.Uniform3i64vNV)
#define glUniform3iv (glad_gles2_context.Uniform3iv)
#define glUniform3ui (glad_gles2_context.Uniform3ui)
#define glUniform3ui64NV (glad_gles2_context.Uniform3ui64NV)
#define glUniform3ui64vNV (glad_gles2_context.Uniform3ui64vNV)
#define glUniform3uiv (glad_gles2_context.Uniform3uiv)
#define glUniform4f (glad_gles2_context.Uniform4f)
#define glUniform4fv (glad_gles2_context.Uniform4fv)
#define glUniform4i (glad_gles2_context.Uniform4i)
#define glUniform4i64NV (glad_gles2_context.Uniform4i64NV)
#define glUniform4i64vNV (glad_gles2_context.Uniform4i64vNV)
#define glUniform4iv (glad_gles2_context.Uniform4iv)
#define glUniform4ui (glad_gles2_context.Uniform4ui)
#define glUniform4ui64NV (glad_gles2_context.Uniform4ui64NV)
#define glUniform4ui64vNV (glad_gles2_context.Uniform4ui64vNV)
#define glUniform4uiv (glad_gles2_context.Uniform4uiv)
#define glUniformBlockBinding (glad_gles2_context.UniformBlockBinding)
#define glUniformHandleui64IMG (glad_gles2_context.UniformHandleui64IMG)
#define glUniformHandleui64NV (glad_gles2_context.UniformHandleui64NV)
#define glUniformHandleui64vIMG (glad_gles2_context.UniformHandleui64vIMG)
#define glUniformHandleui64vNV (glad_gles2_context.UniformHandleui64vNV)
#define glUniformMatrix2fv (glad_gles2_context.UniformMatrix2fv)
#define glUniformMatrix2x3fv (glad_gles2_context.UniformMatrix2x3fv)
#define glUniformMatrix2x3fvNV (glad_gles2_context.UniformMatrix2x3fvNV)
#define glUniformMatrix2x4fv (glad_gles2_context.UniformMatrix2x4fv)
#define glUniformMatrix2x4fvNV (glad_gles2_context.UniformMatrix2x4fvNV)
#define glUniformMatrix3fv (glad_gles2_context.UniformMatrix3fv)
#define glUniformMatrix3x2fv (glad_gles2_context.UniformMatrix3x2fv)
#define glUniformMatrix3x2fvNV (glad_gles2_context.UniformMatrix3x2fvNV)
#define glUniformMatrix3x4fv (glad_gles2_context.UniformMatrix3x4fv)
#define glUniformMatrix3x4fvNV (glad_gles2_context.UniformMatrix3x4fvNV)
#define glUniformMatrix4fv (glad_gles2_context.UniformMatrix4fv)
#define glUniformMatrix4x2fv (glad_gles2_context.UniformMatrix4x2fv)
#define glUniformMatrix4x2fvNV (glad_gles2_context.UniformMatrix4x2fvNV)
#define glUniformMatrix4x3fv (glad_gles2_context.UniformMatrix4x3fv)
#define glUniformMatrix4x3fvNV (glad_gles2_context.UniformMatrix4x3fvNV)
#define glUnmapBuffer (glad_gles2_context.UnmapBuffer)
#define glUnmapBufferOES (glad_gles2_context.UnmapBufferOES)
#define glUseProgram (glad_gles2_context.UseProgram)
#define glUseProgramStages (glad_gles2_context.UseProgramStages)
#define glUseProgramStagesEXT (glad_gles2_context.UseProgramStagesEXT)
#define glValidateProgram (glad_gles2_context.ValidateProgram)
#define glValidateProgramPipeline (glad_gles2_context.ValidateProgramPipeline)
#define glValidateProgramPipelineEXT (glad_gles2_context.ValidateProgramPipelineEXT)
#define glVertexAttrib1f (glad_gles2_context.VertexAttrib1f)
#define glVertexAttrib1fv (glad_gles2_context.VertexAttrib1fv)
#define glVertexAttrib2f (glad_gles2_context.VertexAttrib2f)
#define glVertexAttrib2fv (glad_gles2_context.VertexAttrib2fv)
#define glVertexAttrib3f (glad_gles2_context.VertexAttrib3f)
#define glVertexAttrib3fv (glad_gles2_context.VertexAttrib3fv)
#define glVertexAttrib4f (glad_gles2_context.VertexAttrib4f)
#define glVertexAttrib4fv (glad_gles2_context.VertexAttrib4fv)
#define glVertexAttribBinding (glad_gles2_context.VertexAttribBinding)
#define glVertexAttribDivisor (glad_gles2_context.VertexAttribDivisor)
#define glVertexAttribDivisorANGLE (glad_gles2_context.VertexAttribDivisorANGLE)
#define glVertexAttribDivisorEXT (glad_gles2_context.VertexAttribDivisorEXT)
#define glVertexAttribDivisorNV (glad_gles2_context.VertexAttribDivisorNV)
#define glVertexAttribFormat (glad_gles2_context.VertexAttribFormat)
#define glVertexAttribI4i (glad_gles2_context.VertexAttribI4i)
#define glVertexAttribI4iv (glad_gles2_context.VertexAttribI4iv)
#define glVertexAttribI4ui (glad_gles2_context.VertexAttribI4ui)
#define glVertexAttribI4uiv (glad_gles2_context.VertexAttribI4uiv)
#define glVertexAttribIFormat (glad_gles2_context.VertexAttribIFormat)
#define glVertexAttribIPointer (glad_gles2_context.VertexAttribIPointer)
#define glVertexAttribPointer (glad_gles2_context.VertexAttribPointer)
#define glVertexBindingDivisor (glad_gles2_context.VertexBindingDivisor)
#define glViewport (glad_gles2_context.Viewport)
#define glViewportArrayvNV (glad_gles2_context.ViewportArrayvNV)
#define glViewportArrayvOES (glad_gles2_context.ViewportArrayvOES)
#define glViewportIndexedfNV (glad_gles2_context.ViewportIndexedfNV)
#define glViewportIndexedfOES (glad_gles2_context.ViewportIndexedfOES)
#define glViewportIndexedfvNV (glad_gles2_context.ViewportIndexedfvNV)
#define glViewportIndexedfvOES (glad_gles2_context.ViewportIndexedfvOES)
#define glViewportPositionWScaleNV (glad_gles2_context.ViewportPositionWScaleNV)
#define glViewportSwizzleNV (glad_gles2_context.ViewportSwizzleNV)
#define glWaitSemaphoreEXT (glad_gles2_context.WaitSemaphoreEXT)
#define glWaitSync (glad_gles2_context.WaitSync)
#define glWaitSyncAPPLE (glad_gles2_context.WaitSyncAPPLE)
#define glWaitVkSemaphoreNV (glad_gles2_context.WaitVkSemaphoreNV)
#define glWeightPathsNV (glad_gles2_context.WeightPathsNV)
#define glWindowRectanglesEXT (glad_gles2_context.WindowRectanglesEXT)



GladGLES2Context* gladGetGLES2Context(void);
GLAD_API_CALL void gladSetGLES2Context(GladGLES2Context *context);
